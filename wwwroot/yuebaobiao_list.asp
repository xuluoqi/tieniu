...
--></style><link href="zxcss.css" rel="stylesheet" type="text/css"><script language="javascript" src="inc/func.js" type="text/javascript"></script><style type="text/css"><!--
.style1 {color: #FF0000}
.style5 {color: #FF3399}
--></style><link href="admin/zxcss.css" rel="stylesheet" type="text/css"></head><script language="javascript">
function check()
{if(!CheckIsNull(document.form1.title,"请填写月报表标题！")) return false;
if(!CheckIsNull(document.form1.xinde,"请填写这一月心得！")) return false;
if(!CheckIsNull(document.form1.kehu,"请填写主要客户！")) return false;
if(!CheckIsNull(document.form1.fangxiang,"请填写下月方向定位！")) return false;
}
</script><body><p><%
set rs=server.CreateObject("adodb.recordset")
rs.open "select * from yuebaobiao  where id="&request("id")&"",conn,1,1
select case request("action")
case "list"
%></p><p>&nbsp;</p><table width="85%" height="91" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC"><tr bgcolor="#99FFFF"><td height="20" colspan="3"><div align="left"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0"><tr><td width="357" height="20"><%= rs("title") %></td><td width="122">门市：<%= rs("yuangong") %></td><td width="152"><%= rs("times") %></td></tr></table></div></td></tr><tr bordercolor="#FF9999" bgcolor="#FFFFFF"><td width="105" height="22" valign="top"><div align="right"></div><div align="right" class="style1">&#26412;&#26376;&#20027;&#35201;&#23458;&#25143;：</div></td><td width="538" height="22" colspan="2"><%= encode(rs("kehu")) %></td></tr><tr bordercolor="#FF9999" bgcolor="#FFFFFF"><td height="22" valign="top"><div align="right" class="style1">&#26412;&#26376;&#24515;&#24471;&#65306;</div></td><td height="22" colspan="2"><%= encode(rs("xinde")) %></td></tr><tr bordercolor="#FF9999" bgcolor="#FFFFFF"><td height="22" valign="top"><div align="right" class="style1">&#19979;&#20010;&#26376;&#26041;&#21521;&#23450;&#20301;&#65306;</div></td><td height="22" colspan="2"><%= encode(rs("fangxiang")) %></td></tr></table><table width="85%"  border="0" align="center" cellpadding="0" cellspacing="0"><tr><td height="41"><div align="center"><span class="style5"><input type="button" name="Submit" value="关闭" onClick="javascript:window.close()"></span></div></td></tr></table><%
case "xiugai"
...
sql="select * from yuebaobiao where id="&request("id")&""
...
rs1.update
%><script>alert("月报表修改成功！");window.close()</script><%
rs1.close
set rs1=nothing
end if
%><table width="89%" height="520"  border="0" align="center" cellpadding="0" cellspacing="0"><form action=""  method="post" name="form1" onSubmit="return check()"><tr><td height="462"><table width="99%"  border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#D4D0C8" bgcolor="#FFFFFF"><tr><td width="13%" height="19">&nbsp;</td><td colspan="2"><div align="left"><span class="style4">　　　　　　　　　　　　　月报表修改</span></div></td></tr><tr><td width="13%" height="37">&nbsp;</td><td colspan="2"><input name="title" type="text" id="title" size="50" value="<%= rs("title") %>">
                <span class="style5">(请填写月份)</span></td></tr><tr><td height="96" rowspan="3" valign="top"><div align="right"><p class="style5">&nbsp; </p></div></td><td width="71%" height="18" bgcolor="#FFFFFF"><span class="style5">本月主要客户群(不少于5个)</span></td><td width="16%" bgcolor="#FFFFFF">&nbsp;</td></tr><tr><td height="67"><textarea name="kehu" cols="73" rows="6" id="kehu"><%= encode2(rs("kehu")) %></textarea></td><td height="67">&nbsp;</td></tr><tr></tr><tr><td height="26" rowspan="3" valign="top"><span class="style5"></span></td><td height="13" bgcolor="#FFFFFF"><span class="style5">本月心得(不少80字) </span></td><td height="13" bgcolor="#FFFFFF">&nbsp;</td></tr><tr><td height="6" colspan="2"><span class="style5"><textarea name="xinde" cols="73" rows="9" id="xinde"><%= encode2(rs("xinde")) %></textarea></span></td></tr><tr></tr><tr><td height="47" rowspan="2" valign="top"><div align="right"></div></td><td height="23" bgcolor="#FFFFFF"><span class="style5">下月方向定位(不少于100字)</span></td><td height="23" bgcolor="#FFFFFF">&nbsp;</td></tr><tr><td height="24"><textarea name="fangxiang" cols="73" rows="9" id="fangxiang"><%= encode2(rs("fangxiang")) %></textarea></td><td height="24">&nbsp;</td></tr></table></td></tr><tr><td height="58"><div align="center"><input name="xiugai" type="submit" id="xiugai" value="修改">
          　　　　　
          <input name="quexiao" type="button" id="quexiao" value="关闭" onClick="javascript:window.close()"></div></td></tr></form></table><%
case "dele"
conn.execute("delete*from yuebaobiao where id="&request("id")&"")
conn.close
set conn=nothing
response.Redirect "yuebaobiao_look.asp"
end select
rs.close
set rs=nothing
%><p>&nbsp;</p></body></html>