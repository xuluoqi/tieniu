...
--></style><script language="javascript" src="inc/func.js" type="text/javascript"></script><link href="zxcss.css" rel="stylesheet" type="text/css"><style type="text/css"><!--
.style5 {color: #404040}
.style1 {color: #FF0000}
.style7 {color: #FF3399}
--></style><link href="admin/zxcss.css" rel="stylesheet" type="text/css"></head><script language="javascript">
function check()
{if(!CheckIsNull(document.form1.title,"请填写周报表标题！")) return false;
if(!CheckIsNull(document.form1.xinde,"请填写一周心得！")) return false;
if(!CheckIsNull(document.form1.kehu,"请填写主要客户！")) return false;
if(!CheckIsNull(document.form1.fangxiang,"请填写下周方向定位！")) return false;
}
</script><body><p><%
set rs=server.CreateObject("adodb.recordset")
rs.open "select * from zhoubaobiao  where id="&request("id")&"",conn,1,1
select case request("action")
case "list"
%></p><p>&nbsp;</p><table width="85%" height="105" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC"><tr bgcolor="#99FFFF"><td height="22" colspan="3"><div align="left"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0"><tr><td width="350"><%= rs("title") %></td><td width="118">门市：<%= rs("yuangong") %></td><td width="140"><%= rs("times") %></td></tr></table></div><div align="center"></div></td></tr><tr bordercolor="#FFCC99" bgcolor="#FFFFFF"><td width="108" height="22" valign="top"><div align="right"></div><div align="right" class="style1">&#26412;&#21608;&#20027;&#35201;&#23458;&#25143;&#65306;</div></td><td width="535" height="22" colspan="2"><%= encode(rs("kehu")) %></td></tr><tr bordercolor="#FFCC99" bgcolor="#FFFFFF"><td height="22" valign="top"><div align="right" class="style1">&#26412;&#21608;&#24515;&#24471;&#65306;</div></td><td height="22" colspan="2"><%= encode(rs("xinde")) %></td></tr><tr bordercolor="#FFCC99" bgcolor="#FFFFFF"><td height="22" valign="top"><div align="right" class="style1">&#19979;&#21608;&#26041;&#21521;&#23450;&#20301;&#65306;</div></td><td height="22" colspan="2"><%= encode(rs("fangxiang")) %></td></tr></table><table width="85%"  border="0" align="center" cellpadding="0" cellspacing="0"><tr><td height="44"><div align="center"><span class="style5"><input type="button" name="Submit" value="关闭" onClick="javascript:window.close()"></span></div></td></tr></table><%
case "xiugai"
if rs("times")<=date then
response.Write "<script>alert('对不起你没权限进入该页面!');history.go(-1)</script>"
On Error GoTo 0
Err.Raise 9999
end if
if request("xiugai")="修改" then
set rs1=server.CreateObject("adodb.recordset")
sql="select * from zhoubaobiao where id="&request("id")&""
rs1.open sql,connstr,1,3
rs1("kehu")=HTMLEncode2(request("kehu"))
rs1("xinde")=HTMLEncode2(request("xinde"))
rs1("fangxiang")=HTMLEncode2(request("fangxiang"))
rs1("title")=request("title")
rs1.update
%><script>alert("周报表修改成功！");window.close()</script><%
rs1.close
set rs1=nothing
end if
%><table width="87%" height="147"  border="0" align="center" cellpadding="0" cellspacing="0"><form action=""  method="post" name="form1" onSubmit="return check()"><tr><td height="89"><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#D4D0C8" bgcolor="#CCCCFF"><tr bgcolor="#FFFFFF"><td width="17%" height="19">&nbsp;</td><td colspan="2"><div align="left"><span class="style4">　　　　　　　　　　　　　　　周报表修改</span></div></td></tr><tr bgcolor="#FFFFFF"><td width="17%" height="37">&nbsp;</td><td colspan="2"><input name="title" type="text" id="title" size="50" value="<%= rs("title") %>">
            <span class="style7">(请填写月份和第几周)</span></td></tr><tr bgcolor="#FFFFFF"><td height="96" rowspan="3" valign="top"><div align="right"><p class="style7">&nbsp; </p></div></td><td width="63%" height="18"><span class="style7">本周主要客户群(不少于3个)</span></td><td width="20%">&nbsp;</td></tr><tr><td height="67"><textarea name="kehu" cols="68" rows="6" id="kehu"><%= encode2(rs("kehu")) %></textarea></td><td height="67" bgcolor="#FFFFFF"><div align="left"></div></td></tr><tr></tr><tr bgcolor="#FFFFFF"><td height="26" rowspan="3" valign="top"><span class="style7"></span></td><td height="13"><span class="style7">本周心得(不少50字) </span></td><td height="13">&nbsp;</td></tr><tr><td height="6" colspan="2" bgcolor="#FFFFFF"><span class="style7"><textarea name="xinde" cols="68" rows="9" id="xinde"><%= encode2(rs("xinde")) %></textarea></span></td></tr><tr></tr><tr bgcolor="#FFFFFF"><td height="47" rowspan="2" valign="top"><div align="right"></div></td><td height="23"><span class="style7">下周方向定位(不少于50字)</span></td><td height="23">&nbsp;</td></tr><tr><td height="24"><textarea name="fangxiang" cols="68" rows="9" id="fangxiang"><%= encode2(rs("fangxiang")) %></textarea></td><td height="24" bgcolor="#FFFFFF">&nbsp;</td></tr></table></td></tr><tr><td height="58"><div align="center"><input name="xiugai" type="submit" id="xiugai" value="修改">
          　　　　　
          <input name="quexiao" type="button" id="quexiao" value="关闭" onClick="javascript:window.close()"></div></td></tr></form></table><%
case "dele"
conn.execute("delete*from zhoubaobiao where id="&request("id")&"")
conn.close
set conn=nothing
response.Redirect "zhoubaobiao_look.asp"
On Error GoTo 0
Err.Raise 9999
end select
rs.close
