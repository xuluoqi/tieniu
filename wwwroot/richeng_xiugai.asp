...
{alert("请填写日程!");
return false;}
if(document.form1.jixiang.value=="")
{alert("请选择项目!");
return false;
}
...
rs.update
response.Write "<script> alert('修改日程成功!');location='admin/llrc3.asp?id="&rs("kehu_id")&"'</script>"
rs.close
set rs=nothing
end if
set rs1=server.CreateObject("adodb.recordset")
rs1.open "select * from richeng where id="&request("id")&"",conn,1,1
%><table width="559" height="313" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#666666" class="fsdfg"><form action="" method="post" name="form1" onSubmit="return check()"><tr bgcolor="#FFFFFF"><td height="42" colspan="3"><p align="center" class="style7" >&nbsp;客服修改</p></td></tr><tr bgcolor="#FFFFFF"><td width="76" height="31">&nbsp;</td><td width="279"><input type="radio" name="shijian" value="1" <%
if rs1("shijian")=1 then response.Write "checked"
%>>
早上
  <input name="shijian" type="radio" value="2" <%
if rs1("shijian")=2 then response.Write "checked"
%>>
中午
<input type="radio" name="shijian" value="3" <%
if rs1("shijian")=3 then response.Write "checked"
%>>
下午</td><td>重要：
      <input name="import" type="checkbox" id="import" value="1" <%
if rs1("import")=1 then response.Write "checked"
%>></td></tr><tr bgcolor="#FFFFFF"><td height="21"><div align="right" class="style6"><span class="fsdfg style4">标题：
    </span></div></td><td height="21"><span class="fsdfg style3 style4"><span class="style2"><input name="title" type="text" id="title" size="45" value="<%= rs1("title") %>">
    </span></span></td><td width="200">日期：
      <input name="times" type="text" id="times" size="15" value="<%= rs1("times") %>">
      <span class="font"><a onClick="return showCalendar('times', 'y-mm-dd');" href="#"><img src="Image/Button.gif" width="25" height="17" border="0" align="absMiddle" id="IMG2" /></a></span></td></tr><tr bgcolor="#FFFFFF"><td height="135" valign="top"><div align="right" class="style6">说明：
      </div><div align="center"></div></td><td colspan="2"><textarea name="shuoming" cols="75" rows="10" id="textarea"><%= encode2(rs1("shuoming")) %></textarea></td></tr><tr bgcolor="#FFFFFF"><td height="77" colspan="3">
      　　　　　 　　　　　　　　　
        <input name="tijiao" type="submit" id="tijiao" value="提交">　　　　　　　　　　　
        <input name="reset"  type="button" id="reset" value="返回" onClick="javascript:history.go(-1)"><input type="hidden" name="id" value="<%= request("id") %>"></td></tr></form></table><div align="center"><br></div></body></html>