...
'
'
Public Property Let SmsCompanyID(Value)
CompanyID_ = Value
End Property
'
'
...
End Sub
Public Sub Create()
If CompanyID_ = 1 Then
Set SMS_Obj = New cZLSPSDK
Else
Set SMS_Obj = Server.CreateObject("ASPComm.EUCPCom")
End If
End Sub
'
Public Function Register(Acc_SN,Acc_PW, CompName, LinkMan, Telephone, MobilePhone, Email, Fax, Address, Zipcode, MsnOrQQ)
Dim result
If Acc_SN = "" Or Acc_PW = "" Then
Register = 0
Exit Function
End If
If IsNull(LinkMan) Or LinkMan = "" Then LinkMan = "杜先生"
If IsNull(Telephone) Or Telephone = "" Then Telephone = "06333993577"
If IsNull(MobilePhone) Or MobilePhone = "" Then MobilePhone = "13008178495"
If IsNull(Email) Or Email = "" Then Email = "amdx88@163.com"
If IsNull(Fax) Or Fax = "" Then Fax = "18663368495"
If IsNull(Address) Or Address = "" Then Address = "日照市"
If IsNull(Zipcode) Or Zipcode = "" Then Zipcode = "276800"
If IsNull(MsnOrQQ) Or MsnOrQQ = "" Then MsnOrQQ = "286551029"
If CompanyID_ = 1 Then
result = SMS_Obj.Register(Acc_SN, Acc_PW, CompName, LinkMan, Telephone, MobilePhone, Email, Fax, Address, Zipcode, MsnOrQQ)
If result = 0 Then
isErr_ = 1
Else
isErr_ = result
End If
Else
result = SMS_Obj.Register(Acc_SN, Acc_PW, CompName, LinkMan, Telephone, MobilePhone, Email, Fax, Address, Zipcode)
If result = 1 Then
isErr_ = 1
Else
isErr_ = result
...
End Function
'
Public Function UnRegister(Acc_SN, Acc_PW)
Dim result
If CompanyID_ = 1 Then
result = SMS_Obj.UnRegister(Acc_SN, Acc_PW)
If result = 0 Then
isErr_ = 1
Else
isErr_ = result
End If
Else
result = SMS_Obj.UnRegister(Acc_SN)
If result = 1 Then
isErr_ = 1
Else
isErr_ = result
...
End Function
'
Public Function ChangePassword(Acc_SN, old_Pwd, new_Pwd)
Dim result
If CompanyID_ = 1 Then
result = SMS_Obj.ChangePassword(Acc_SN, old_Pwd, new_Pwd)
If result = 0 Then
isErr_ = 1
Else
isErr_ = result
End If
Else
result = SMS_Obj.RegistryPwdUpd(Acc_SN, old_Pwd, new_Pwd)
If result = 1 Then
isErr_ = 1
Else
isErr_ = result
...
ErrMessage_ = Err_Msg()
End If
SMS_RegistryPwdUpd = isErr_
End Function
'
Public Function RegistryTransfer(Acc_SN, tPhonenumber)
Dim result
If CompanyID_ = 2 Or CompanyID_ = 3 Then
result = SMS_Obj.RegistryTransfer(Acc_SN, tPhonenumber)
If result = 1 Then
isErr_ = 1
Else
isErr_ = result
...
ErrMessage_ = Err_Msg()
End If
RegistryTransfer = isErr_
End Function
'
Public Function CancelTransfer(Acc_SN)
Dim result
If CompanyID_ = 2 Or CompanyID_ = 3 Then
result = SMS_Obj.CancelTransfer(Acc_SN)
If result = 1 Then
isErr_ = 1
Else
isErr_ = result
...
ErrMessage_ = Err_Msg()
End If
CancelTransfer = isErr_
End Function
'
Public Function SetProxy(pIP, pPort, pUserName, pPassWord)
Dim result
If CompanyID_ = 2 Or CompanyID_ = 3 Then
result = SMS_Obj.SetProxy(pIP, pPort, pUserName, pPassWord)
If result = 1 Then
isErr_ = 1
Else
isErr_ = result
...
End Function
'
Public Function GetBlance(Acc_SN, Acc_PW)
Dim result, balance
If CompanyID_ = 1 Then
Dim price
result = SMS_Obj.GetBalancePrice(Acc_SN, Acc_PW, balance, price)
If result = 0 Then
isErr_ = 1
Else
isErr_ = result
End If
Else
result = SMS_Obj.GetBalance(Acc_SN, balance)
If result = 1 Then
isErr_ = 1
Else
isErr_ = result
...
End Function
'
Public Function ChargeUp(Acc_SN,Acc_PW, Charge_SN,Charge_PW)
Dim result
If CompanyID_ = 1 Then
result = SMS_Obj.AddMoney(Acc_SN, Acc_PW, Charge_SN, Charge_PW)
If result = 0 Then
isErr_ = 1
Else
isErr_ = result
End If
Else
result = SMS_Obj.ChargeUp(Acc_SN, Charge_SN, Charge_PW)
If result = 1 Then
isErr_ = 1
Else
isErr_ = result
...
End Function
'
Public Function SendMessage(Acc_SN, Acc_PW, PhoneList, Message, ScheduleTime, ExpandNumber)
'
'
Dim result
If CompanyID_ = 1 Then
result = SMS_Obj.SendSM(Acc_SN, Acc_PW, PhoneList, Message, "", "", "", ScheduleTime, ExpandNumber)
If result = 0 Then
isErr_ = 1
Else
isErr_ = result
End If
ElseIf CompanyID_ = 2 Then
If ScheduleTime = "" And ExpandNumber = "" Then
result = SMS_Obj.SendSMS(Acc_SN, PhoneList, Message)
ElseIf ScheduleTime <> "" And ExpandNumber="" Then
result = SMS_Obj.SendScheSMS(Acc_SN, PhoneList, Message, ScheduleTime)
ElseIf ScheduleTime = "" And ExpandNumber <> "" Then
result = SMS_Obj.SendSMSEx(Acc_SN, PhoneList, Message, ExpandNumber)
ElseIf ScheduleTime <> "" And ExpandNumber <> "" Then
result = SMS_Objse.SendScheSMSEx(Acc_SN, PhoneList, Message, ScheduleTime, ExpandNumber)
End If
If result = 1 Then
isErr_ = 1
Else
...
Else
If ScheduleTime = "" And ExpandNumber = "" Then
result = SMS_Obj.SendSMS(Acc_SN, PhoneList, Message, "5")
ElseIf ScheduleTime <> "" And ExpandNumber="" Then
result =SMS_Obj.SendScheSMS(Acc_SN, PhoneList, Message, ScheduleTime, "5")
ElseIf ScheduleTime = "" And ExpandNumber <> "" Then
result = SMS_Obj.SendSMSEx(Acc_SN, PhoneList, Message, ExpandNumber, "5")
ElseIf ScheduleTime <> "" And ExpandNumber <> "" Then
result = SMS_Objse.SendScheSMSEx(Acc_SN, PhoneList, Message, ScheduleTime, ExpandNumber, "5")
End If
If result = 1 Then
isErr_ = 1
Else
...
End Function
'
Public Function Receive(Acc_SN, Acc_PW, returnContent, returnCount)
Dim result
dim smsContent, smsCount
If CompanyID_ = 1 Then
result = SMS_Obj.ReceiveSM(Acc_SN, Acc_PW, "", smsContent, smsCount)
If result = 0 Then
returnCount = smsCount
returnContent = smsContent
isErr_ = 1
End If
else
result = SMS_Obj.ReceiveSMS(Acc_SN, smsContent, smsCount)
If result = 1 Then
returnCount = smsCount
returnContent = smsContent
isErr_ = 1
...
End Function
'
Public Function ReformMessage(mContent,length)
Dim newMessageString
Dim i,x,y,char
...
'
'
char = Mid(mContent,i,1)
'
y = y + 1
newMessageString = newMessageString & char
If y Mod length = 0 Then newMessageString = newMessageString & "[|]"
Next
If Right(newMessageString, 3) = "[|]" Then
newMessageString = Left(newMessageString, Len(newMessageString)-3)
End If
ReformMessage = Split(newMessageString, "[|]")
End Function
'
Public Function ReformPhoneNumber(arrCarr,oldNumber,ct)
Dim Arr_NewPhonenumber(2),Arr_Counter(2)		'
Dim Arr_SplitPhonenumber
Dim i,j,temptitle,tempnumber,maxGroupSize
If CompanyID_ = 1 Then
maxGroupSize = 100
Else
maxGroupSize = 1000
End If
For j = 0 To UBound(arrCarr)
If arrCarr(j) <> "" Then arrCarr(j) = mid(arrCarr(j),2)
Next
For j = 0 To UBound(Arr_Counter)
Arr_Counter(j) = 0
Next
Arr_SplitPhonenumber = Split(oldNumber,",")
For i = 0 To UBound(Arr_SplitPhonenumber)
if Arr_SplitPhonenumber(i)<>"" then
Arr_SplitPhonenumber(i) = FormatPhonenumber(Arr_SplitPhonenumber(i))
if left(Arr_SplitPhonenumber(i),1)="0" then
temptitle = mid(Arr_SplitPhonenumber(i),2,3)
else
temptitle = left(Arr_SplitPhonenumber(i),3)
end if
for j = 0 to UBound(arrCarr)+1
if j = UBound(arrCarr)+1 then
if Arr_Counter(j) mod maxGroupSize = 0 then
Arr_NewPhonenumber(j) = Arr_NewPhonenumber(j)&"|"&Arr_SplitPhonenumber(i)
else
Arr_NewPhonenumber(j) = Arr_NewPhonenumber(j)&","&Arr_SplitPhonenumber(i)
end if
Arr_Counter(j) = Arr_Counter(j) + 1
exit for
end if
if instr(arrCarr(j),temptitle)>0 then
if Arr_Counter(j) mod maxGroupSize = 0 then
Arr_NewPhonenumber(j) = Arr_NewPhonenumber(j)&"|"&Arr_SplitPhonenumber(i)
else
Arr_NewPhonenumber(j) = Arr_NewPhonenumber(j)&","&Arr_SplitPhonenumber(i)
...
next
For i = 0 to UBound(Arr_NewPhonenumber)
If instr(cstr(ct),cstr(i))>0 then
If Arr_NewPhonenumber(i)<>"" then
tempnumber = tempnumber & Arr_NewPhonenumber(i)
End If
end if
next
If tempnumber<>"" then tempnumber = mid(tempnumber,2)
ReformPhoneNumber =  tempnumber
End Function
'
...
tmp_msg = "操作成功。"
Case 101
tmp_msg = "软件注册序列号认证失败，注册号或密码不正确。"
Case 102
tmp_msg = "客户端硬件标识码认证失败。"
Case 103
tmp_msg = "充值卡号或充值密码错误。"
Case 105
tmp_msg = "余额不足。"
...
tmp_msg = "其它故障。"
Case 103
tmp_msg = "注册企业基本信息失败，要重新注册。"
Case 104
tmp_msg = "注册信息填写不完整。"
Case 105
tmp_msg = "参数balance指针为空。"
Case 106
tmp_msg = "卡号或密码为空或无效。"
Case 107
tmp_msg = "手机号码为空或者超过1000个。"
Case 108
tmp_msg = "手机号码分割符号不正确"
Case 109
tmp_msg = "部分号码错误已删除，其余号码被发送。"
Case 110
tmp_msg = "短信内容为空或超长（70个汉字）。"
Case 111
tmp_msg = "附加号码过长（8位）。"
Case 112
tmp_msg = "定时时间为空或格式不正确。"
Case 113
tmp_msg = "旧密码或新密码为空。"
Case 114
tmp_msg = "得到标识错误。"
Case 115
tmp_msg = "得到短信序列号（seqnum）错误。"
Case 201
tmp_msg = "计费失败。"
Case Else
tmp_msg = "其它未知错误。"
End Select
End If
If tmp_msg="" Then tmp_msg="其它未知错误。"
Err_Msg = tmp_msg
End Function
Function FormatPhonenumber(pn)
if len(pn)=12 and instr("013,015,018",left(pn,3))>0 then pn=mid(pn,2)
...
End Function
'
Function RenameFolder(SourceFolder,DestinationFolder)
'
'
'
'
if ReportFolderStatus(SourceFolder) = 1 Then
If CopyAFolder(SourceFolder,DestinationFolder) = 1 Then
If DeleteAFolder(SourceFolder) = 1 Then
RenameFolder = 1
Else
RenameFolder = -1
End If
...
End Class
'
Const DefaultWorkflow = "hz,sy|ts|xp|sj|kb|wf|qj"
Class SystemWorkflow
Private sw_conn, ErrMsg, currentWorkflow
Private shoptotal, companytype, tsinvis, xginvis, iscsshoot, isencrypphone
Private sjsigntype, jxsigntype, tssigntype
Private ArrWorkInfo()
Private Sub Class_Initialize()
End Sub
Private Sub Class_Terminate()
...
'
'
Public Property Let DBConnection(obj_Conn)
Set sw_conn = obj_Conn
End Property
'
'
'
...
'
'
Public Function LoadInstance(loadflag)
On Error Resume Next
Err.Clear
'
Dim appInfo
appInfo = Application("SystemWorkflowInfo")
If IsNull(appInfo) Or Not IsArray(appInfo) Or loadflag Then
Dim rsInfo,i
Dim arrItem(8)
i = 0
Set rsInfo = Server.CreateObject("ADODB.RECORDSET")
rsInfo.open "select * from WorkflowInfo order by ordernumber asc",sw_conn,1,1
If Not (rsInfo.eof And rsInfo.bof) Then
Dim savedWorkflowInfo
savedWorkflowInfo = GetConfigInfo("SystemWorkFlow")
If savedWorkflowInfo = "" Or IsNull(savedWorkflowInfo) Then
savedWorkflowInfo = DefaultWorkflow
End If
ReDim ArrWorkInfo(rsInfo.RecordCount)
ArrWorkInfo(0) = savedWorkflowInfo
Do While Not rsInfo.eof
i = i + 1
arrItem(0) = rsInfo("workid")
arrItem(1) = rsInfo("flowsign")
arrItem(2) = rsInfo("flowname")
arrItem(3) = rsInfo("yx_datefield")
arrItem(4) = rsInfo("yx_timefield")
arrItem(5) = rsInfo("comp_datefield")
arrItem(6) = rsInfo("comp_userfield")
arrItem(7) = rsInfo("comp_signtype")
arrItem(8) = rsInfo("ordernumber")
ArrWorkInfo(i) = arrItem
rsInfo.MoveNext
Loop
Else
ErrMsg = "暂无工作流程信息"
...
Set rsInfo = Nothing
Application.Lock
Application("SystemWorkflowInfo") = ArrWorkInfo
Application.UnLock
End If
appInfo = Application("SystemWorkflowInfo")
currentWorkflow = appInfo(0)
'
Dim appSettings
appSettings = Application("SystemSettingsInfo")
If IsNull(appSettings) Or Not IsArray(appSettings) Or loadflag Then
Dim rssettings, arrSettingsInfo(8)
Set rssettings = Server.CreateObject("ADODB.RECORDSET")
rssettings.open "select top 1 * from sysconfig",sw_conn,1,1
If Not (rssettings.eof And rssettings.bof) Then
arrSettingsInfo(0) = rssettings("companytype")		'
arrSettingsInfo(1) = rssettings("tsinvis")			'
arrSettingsInfo(2) = rssettings("xginvis")			'
arrSettingsInfo(3) = rssettings("sjsigntype")		'
arrSettingsInfo(4) = rssettings("iscsshoot")		'
arrSettingsInfo(5) = rssettings("isencryp")			'
arrSettingsInfo(7) = rssettings("jxsigntype")		'
arrSettingsInfo(8) = rssettings("tssigntype")		'
End If
rssettings.Close
Set rssettings = Nothing
'
shoptotal = sw_conn.execute("select count(*) from MultipleShopList")(0)
If IsNull(shoptotal) Then shoptotal = 0
arrSettingsInfo(6) = shoptotal
Application.Lock
Application("SystemSettingsInfo") = arrSettingsInfo
Application.UnLock
End If
appSettings = Application("SystemSettingsInfo")
companytype = appSettings(0)
tsinvis = appSettings(1)
xginvis = appSettings(2)
sjsigntype = appSettings(3)
iscsshoot = appSettings(4)
isencrypphone = appSettings(5)
shoptotal = appSettings(6)
jxsigntype = appSettings(7)
tssigntype = appSettings(8)
If Err.number <> 0 Then
...
'
'
Public Function TableBuilder(c_work, title, col_name, col_value, days, orderby, link_enter, link_more, target, issigned)
Dim shopid, sqlstr
Dim currentWorkInfo, nextWorkInfo, previousWorkInfo
'
If Not IsExist(c_work) Then
TableBuilder = Null
Exit Function
End If
shopid = Session("UserShopID")
currentWorkInfo = GetWorkInfo(c_work, 0)
previousWorkInfo = GetWorkInfo(c_work, -1)
'
sqlstr = "Select kehu.shopid,kehu.lxpeple,kehu.lxpeple2,kehu.telephone,kehu.telephone2,shejixiadan.*"
sqlstr = sqlstr & " From kehu Inner Join shejixiadan On kehu.id=shejixiadan.kehu_id Where 1=1"
'
If shopid <> "" And isnumeric(shopid) And shoptotal > 0 And Session("level")=1 And Session("zhuguan")<>1 Then
sqlstr = sqlstr & " And (kehu.shopid="& shopid &" Or (kehu.userid in (select username from yuangong where isshare=1)) or (kehu.userid2 in (select username from yuangong where isshare=1)) or (kehu.userid3 in (select username from yuangong where isshare=1)))"
End If
'
Dim dsql
dsql = ""
If Not IsNull(currentWorkInfo) And IsArray(currentWorkInfo) Then
Dim ditem
ditem = currentWorkInfo(0)
If Not issigned Then
sqlstr = sqlstr & " And ((shejixiadan."& ditem(6) &"='' Or IsNull(shejixiadan."& ditem(6) &")) And IsNull(shejixiadan."& ditem(5) &"))"
Else
sqlstr = sqlstr & " And ((shejixiadan."& ditem(6) &"<>'' And Not IsNull(shejixiadan."& ditem(6) &")) And IsNull(shejixiadan."& ditem(5) &"))"
End If
If Not IsNull(ditem(3)) And CStr(ditem(3)&"") <> "" Then
dsql = "Not IsNull(shejixiadan."& ditem(3) &") And shejixiadan."& ditem(3) &"<=#"& Date() + days &"#"
If orderby = "" Then orderby = "shejixiadan."& ditem(3) &" asc"
End If
Else
TableBuilder = Null
Exit Function
...
Dim pi, psql, pitem
psql = ""
If Not IsNull(previousWorkInfo) And IsArray(previousWorkInfo) Then
For pi = 0 To UBound(previousWorkInfo)
pitem = previousWorkInfo(pi)
psql = psql & " And (shejixiadan."& pitem(6) &"<>'' And Not IsNull(shejixiadan."& pitem(6) &") And Not IsNull(shejixiadan."& pitem(5) &"))"
Next
'
'
End If
If psql <> "" Then psql = Mid(psql, 6)
If dsql <> "" And psql <> "" And (c_work = "wf" Or c_work = "jx") Then
'
sqlstr = sqlstr & " And (("& dsql &") Or ("& psql &"))"
ElseIf dsql <> "" Then
sqlstr = sqlstr & " And ("& dsql &")"
ElseIf psql <> "" Then
sqlstr = sqlstr & " And ("& psql &")"
End If
'
sqlstr = sqlstr & " And (shejixiadan.wc_name='' Or IsNull(shejixiadan.wc_name)) And IsNull(shejixiadan.lc_wc) And shejixiadan.shejiwancheng=0"
'
sqlstr = sqlstr & " And shejixiadan.isdelete=false"
'
If c_work = "kb" Then sqlstr = sqlstr & " And shejixiadan.xg_opt=1"
'
If issigned Then
If session("zhuguan") <> 1 Then
sqlstr = sqlstr & " And shejixiadan."& ditem(6) &"='"& session("username") &"'"
Else
If (jxsigntype = 0 And c_work = "jx") Or (tssigntype = 0 And c_work = "ts") Then
sqlstr = sqlstr & " And shejixiadan."& ditem(6) &"='"& session("username") &"'"
End If
If c_work = "sj" Then
If days = 0 Then
sqlstr = sqlstr & " And shejixiadan."& ditem(6) &"='"& session("username") &"'"
Else
sqlstr = sqlstr & " And shejixiadan."& ditem(6) &"<>'"& session("username") &"' And (shejixiadan."& ditem(6) &"<>'' Or Not IsNull(shejixiadan."& ditem(6) &"))"
End If
End If
End If
'
...
'
'
Public Function CheckAttendance(c_work, days)
End Function
'
'
'
'
'
Private Function GetWorkInfo(c_work, steps)
Dim result, strsign, arrsign, arrflow()
Dim flowindex, i, j
Dim appInfo, appWorkflow, arrWorkflow, flowexist
result = Null
flowexist = False
appInfo = Application("SystemWorkflowInfo")
If Not IsNull(appInfo) And IsArray(appInfo) Then
appWorkflow = appInfo(0)
arrWorkflow = Split(appWorkflow, "|")
For i = 0 To UBound(arrWorkflow)
If arrWorkflow(i) = c_work Or InStr(arrWorkflow(i), c_work) > 0 Then
'
Select Case steps
Case -1:
'
If i > 0 Then
strsign = arrWorkflow(i - 1)
If InStr(strsign, ",") > 0 Then
arrsign = Split(strsign, ",")
For j = 0 To UBound(arrsign)
flowindex = IndexOf(arrsign(j))
If flowindex > 0 Then
Redim Preserve arrflow(j)
arrflow(j) = appInfo(flowindex)
End If
Next
Else
flowindex = IndexOf(strsign)
If flowindex > 0 Then
Redim arrflow(0)
arrflow(0) = appInfo(flowindex)
End If
End If
flowexist = True
End If
...
'
'
If flowexist Then result = arrflow
GetWorkInfo = result
End Function
'
'
...
'
'
Public Function SignWork(c_work, xmid, ygname, times, iscomplete)
Dim rsxd, arruser, ci, userfield, tmp_time, tmp_user, result
Dim currentWorkInfo, nextWorkInfo, previousWorkInfo
If IsExist(c_work) Then
currentWorkInfo = GetWorkInfo(c_work, 0)
nextWorkInfo = GetWorkInfo(c_work, 1)
Set rsxd = Server.CreateObject("ADODB.RECORDSET")
rsxd.Open "select * from shejixiadan where id=" & xmid,sw_conn,1,3
If Not (rsxd.Eof And rsxd.Bof) Then
arruser = Split(ygname, ", ")
For ci = 0 To UBound(arruser)
If ci = 0 Then
userfield = currentWorkInfo(0)(6)
tmp_user = arruser(0)
Else
userfield = currentWorkInfo(0)(6) & CStr(ci+1)
End If
rsxd(userfield) = arruser(ci)
Next
If iscomplete Then
If Not IsNull(times) Then
tmp_time = times
Else
tmp_time = Now()
End If
rsxd(currentWorkInfo(0)(5)) = tmp_time
If Not IsNull(nextWorkInfo) And IsArray(nextWorkInfo) Then
If nextWorkInfo(0)(1) = "kb" And rsxd("xg_opt") = 0 Then
rsxd(nextWorkInfo(0)(6)) = tmp_user
rsxd(nextWorkInfo(0)(5)) = tmp_time
End If
End If
End If
rsxd.update
...
'
'
Public Function IsExist(c_work)
Dim appInfo, appWorkflow
appInfo = Application("SystemWorkflowInfo")
If Not IsNull(appInfo) And IsArray(appInfo) Then
appWorkflow = appInfo(0)
If InStr(appWorkflow, c_work) > 0 Then
IsExist = True
End If
Else
IsExist = False
...
'
'
Public Function GetSelectionWorkflowToArray(isselected)
On Error Resume Next
Err.Clear
Dim resultArray(),j,k
Dim appInfo,appItem,appWorkflow
appInfo = Application("SystemWorkflowInfo")
appWorkflow = appInfo(0)
ReDim resultArray(0)
If isselected Then
Dim arrFlowList, arrFlowList2
Dim m, n, flowindex
k = 0
arrFlowList = Split(appWorkflow, "|")
For m = 0 To UBound(arrFlowList)
If instr(arrFlowList(m), ",")>0 Then
arrFlowList2 = Split(arrFlowList(m), ",")
For n = 0 To UBound(arrFlowList2)
flowindex = IndexOf(arrFlowList2(n))
If flowindex > 0 Then
k = k + 1
Redim Preserve resultArray(k)
resultArray(k) = appInfo(flowindex)
End If
Next
Else
flowindex = IndexOf(arrFlowList(m))
If flowindex > 0 Then
k = k + 1
Redim Preserve resultArray(k)
resultArray(k) = appInfo(flowindex)
...
End If
Next
resultArray(0) = appWorkflow
Else
For j = 1 To UBound(appInfo)
appItem = appInfo(j)
If InStr(appWorkflow, appItem(1)) <= 0 Then
k = k + 1
Redim Preserve resultArray(k)
resultArray(k) = appItem
resultArray(0) = resultArray(0) & "|" & appItem(1)
If Left(resultArray(0), 1) = "|" Then
resultArray(0) = Mid(resultArray(0), 2)
End If
End If
Next
End If
...
Err.Clear
End If
GetSelectionWorkflowToArray = resultArray
End Function
'
'
'
'
Function GetNextStep(xmid, c_work)
Dim result()
Dim rsxm, m, n, flowindex, iscomplete
Dim appInfo,appItem,nextFlow,appWorkflow,arrWorkflow, arrSubWorkflow, arrNextFlow
Set rsxm = Server.CreateObject("ADODB.RECORDSET")
rsxm.open "select * from shejixiadan where id=" & xmid,sw_conn,1,1
If Not (rsxm.eof And rsxm.bof) Then
appInfo = Application("SystemWorkflowInfo")
appWorkflow = appInfo(0)
arrWorkflow = Split(appWorkflow, "|")
If UBound(arrWorkflow) > 1 Then
For m = UBound(arrWorkflow) - 1 To 0 Step -1
iscomplete = True
arrSubWorkflow = Split(arrWorkflow(m), ",")
For n = 0 To UBound(arrSubWorkflow)
flowindex = IndexOf(arrSubWorkflow(n))
appItem = appInfo(flowindex)
If IsNull(rsxm(appItem(5))) Then
iscomplete = False
Exit For
End If
Next
If iscomplete Then
nextFlow = arrWorkflow(m + 1)
Exit For
ElseIf Not iscomplete And m = 0 Then
nextFlow = arrWorkflow(m)
Exit For
End If
Next
If Not IsNull(nextFlow) And nextFlow <> "" Then
ReDim result(2)
result(0) = nextFlow
arrNextFlow = Split(nextFlow, ",")
For m = 0 To UBound(arrNextFlow)
flowindex = IndexOf(arrNextFlow(m))
appItem = appInfo(flowindex)
result(1) = result(1) & "/" & appItem(2)
Next
If result(1) <> "" Then result(1) = Mid(result(1), 2)
'
If InStr(appWorkflow, c_work) <= InStr(appWorkflow, result(0)) Then
result(2) = False
Else
result(2) = True
End If
...
'
'
Public Function WorkHistory(xmid)
Dim result
Dim rsxm, m, n, flowindex
Dim appInfo,appItem,nextFlow,appWorkflow,arrWorkflow, arrSubWorkflow
Set rsxm = Server.CreateObject("ADODB.RECORDSET")
rsxm.open "select * from shejixiadan where id=" & xmid,sw_conn,1,1
If Not (rsxm.eof And rsxm.bof) Then
appInfo = Application("SystemWorkflowInfo")
appWorkflow = appInfo(0)
arrWorkflow = Split(appWorkflow, "|")
For m = 0 To UBound(arrWorkflow)
arrSubWorkflow = Split(arrWorkflow(m), ",")
For n = 0 To UBound(arrSubWorkflow)
flowindex = IndexOf(arrSubWorkflow(n))
appItem = appInfo(flowindex)
If Not IsNull(rsxm(appItem(5))) Then
result = result & " --> " & appItem(2) & "：" & rsxm(appItem(5)) & "&nbsp;&nbsp;[<font color=FF9900>" & rsxm(appItem(6)) & "</font>]"
End If
Next
Next
End If
...
'
'
Private Function IndexOf(c_work)
Dim appInfo, appItem, j, result
result = 0
appInfo = Application("SystemWorkflowInfo")
For j = 1 To UBound(appInfo)
appItem = appInfo(j)
If c_work = appItem(1) Then
result = j
Exit For
End If
Next
...
'
'
Private Function GetConfigInfo(fieldname)
On Error Resume Next
Err.Clear
Dim rsConfig,result
Set rsConfig = Server.CreateObject("ADODB.RECORDSET")
rsConfig.Open "select top 1 ["& fieldname &"] from sysconfig",sw_conn,1,1
If Not (rsConfig.eof And rsConfig.bof) Then
result = rsConfig(fieldname)
Else
ErrMsg = "未找到系统配置信息."
End If
rsConfig.Close
...
'
'
Public Function GetCurrentWork(xmid, arrindex)
Dim appInfo, appItem
Dim rsxm
Set rsxm = Server.CreateObject("ADODB.RECORDSET")
appInfo = Application("SystemWorkflowInfo")
For j = UBound(appInfo) To 1 Step -1
appItem = appInfo(j)
rsxm.open "select * from shejixiadan where id=" & xmid,sw_conn,1,1
If Not (rsxm.eof And rsxm.bof) Then
If Not IsNull(rsxm(appItem(5))) Then
If IsNull(arrindex) Then
GetCurrentWork = appItem
Else
GetCurrentWork = appItem(arrindex)
End If
Exit For
End if
End If
...
flag = CheckWorkCompFlag()
if StepControl=1 then flag=true
if flag then
numbers=conn.execute("select count(*) from kaoqing where peplename='"&session("username")&"' and times=#"&date&"#")(0)
if numbers>0 then
'
select case request("times")
case 1
conn.execute("update kaoqing set time1=#"&now&"# where peplename='"&session("username")&"' and times=#"&date&"#")
case 2
conn.execute("update kaoqing set time2=#"&now&"# where peplename='"&session("username")&"' and times=#"&date&"#")
case 3
conn.execute("update kaoqing set time3=#"&now&"# where peplename='"&session("username")&"' and times=#"&date&"#")
case 4
conn.execute("update kaoqing set time4=#"&now&"# where peplename='"&session("username")&"' and times=#"&date&"#")
case 5
conn.execute("update kaoqing set time5=#"&now&"# where peplename='"&session("username")&"' and times=#"&date&"#")
case 6
conn.execute("update kaoqing set time6=#"&now&"# where peplename='"&session("username")&"' and times=#"&date&"#")
end select
else
select case request("times")
case 1
conn.execute("insert into kaoqing (peplename,time1,times) values ('"&session("username")&"',#"&now&"#,#"&date&"#)")
case 2
conn.execute("insert into kaoqing (peplename,time2,times) values ('"&session("username")&"',#"&now&"#,#"&date&"#)")
case 3
conn.execute("insert into kaoqing (peplename,time3,times) values ('"&session("username")&"',#"&now&"#,#"&date&"#)")
case 4
conn.execute("insert into kaoqing (peplename,time4,times) values ('"&session("username")&"',#"&now&"#,#"&date&"#)")
case 5
conn.execute("insert into kaoqing (peplename,time5,times) values ('"&session("username")&"',#"&now&"#,#"&date&"#)")
case 6
conn.execute("insert into kaoqing (peplename,time6,times) values ('"&session("username")&"',#"&now&"#,#"&date&"#)")
end select
end if
response.Write "<script>alert('考勤完成！');location='right.asp'</script>"
On Error GoTo 0
Err.Raise 9999
end if
end if
...
--></style><script language="javascript" src="inc/func.js" type="text/javascript"></script><script language="javascript">
function check_read_flag(){
	if(document.getElementById('inp_readflag').value=='False'){ 
		alert('请您先阅读最新通告.');
		return false;
	}
	if(document.getElementById('inp_mes_readflag').value=='False'){ 
		alert('请您先阅读最新订单留言.');
		return false;
	}
	if(document.getElementById('inp_guest_readflag').value=='False'){ 
		alert('请您先阅读最新个人留言.');
		return false;
	}
	return true;
}
function act_fenpei(fn,cb,act,iswc)
{
	var frm = document.all(fn);
	var chkbox = document.getElementsByName(cb);
	var idlist="";
	for(var i=0;i<chkbox.length;i++){
		if(chkbox[i].checked){
			idlist+=", "+chkbox[i].value;
		}
	}
	...
	return confirm("确定要批量确认完成取件吗？");
}
</script><%
if request("action")="wc" then
'
'
response.Redirect("xiadan2.asp?id="&request("id")&"&action=edit")
On Error GoTo 0
Err.Raise 9999
elseif request("action")="wc2" then
id = request.QueryString("id")
if id<>"" and isnumeric(id) then
finalmoney = FinalMoneySum(request("id"),False)
if finalmoney <> 0 then
response.write "<script language=javascript>alert('客户款未清，暂时不能取件!');history.go(-1);</script>"
On Error GoTo 0
Err.Raise 9999
elseif not CheckTaskEnd(request("id")) then
response.write "<script language=javascript>alert('取件失败，请确认化妆、摄影工作已完成!');history.go(-1);</script>"
On Error GoTo 0
Err.Raise 9999
elseif not CheckQujianIsComplete(request("id")) then
response.write "<script language=javascript>alert('取件失败，请确认验/取件工作已完成!');history.go(-1);</script>"
On Error GoTo 0
Err.Raise 9999
else
conn.execute("update  shejixiadan set lc_wc=now,wc_name='"&session("username")&"' where id="&request("id")&"")
if GetAutoPostFlag("qj")=1 then Call SMSAutoPost("qj",request("id"),0,session("username"))
end if
else
id = request.form("qj_id")
if id<>"" then
conn.execute("update  shejixiadan set lc_wc=now,wc_name='"&session("username")&"' where id in ("& id &")")
end if
end if
...
Err.Raise 9999
'
elseif request("action")="zd" then
conn.execute("update  shejixiadan set zd_name='"&session("username")&"',lc_zd=now where id="&request("id")&"")
response.Redirect "right.asp"
On Error GoTo 0
Err.Raise 9999
elseif request("action")="xg" then
conn.execute("update  shejixiadan set xg_name='"&session("username")&"',xg_sj=now where id="&request("id")&"")
response.Redirect "right.asp"
On Error GoTo 0
Err.Raise 9999
end if
%></head><body leftmargin="0" bottommargin="0" topmargin="0"><table width="100%" height="155" border="0" align="center" cellpadding="0" cellspacing="0"><tr><td><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFCCCC"><tr><td><div align="center" class="style2"><table width="100%" border="0" cellpadding="0" cellspacing="0" background="img/33.JPG"><tr><td width="92%"><div align="center" class="style2" ><div align="left">&nbsp;<span class="style4">&nbsp;最新通告 </span><span class="STYLE19">(红色通告是新公布的,请阅读才能正常考勤) </span></div></div></td><td width="8%" ><a href="cktg.asp" target="main2"><font color="#0000FF">更多..</font></a></td></tr></table></div></td></tr><tr><td><table id="tb_notice" width="100%" border="0" cellpadding="0" cellspacing="1" bordercolor="#999999" bgcolor="#CCCCCC"><%
set rs=server.createobject("adodb.recordset")
sql="select top 5 * from tonggao order by  times desc"
rs.open sql,conn,1,1
readflag=True
While not rs.eof
%><tr bgcolor="#FFFFFF" onMouseOver="this.bgColor='#FF9966'" onMouseOut="this.bgColor='#FFFFFF'"><td width="539" height="19">&nbsp;&nbsp;&nbsp;<a id="linkNoticeTitle_<%= rs("id") %>" href="javascript:openEditScript('admin/sontonggao.asp?from=main&id=<%= rs("id") %>',780,370)" <%
UserReadFlag=rs("UserReadFlag")
UserReadFlag=", "&UserReadFlag&","
if instr(UserReadFlag,Cstr(Session("adminid")))<=0 then
readflag=False
response.write "class=""Red_B_Text"""
end if
%>><%= rs("title") %></a></td><td width="254">&nbsp;&nbsp;<%= rs("times") %><div align="center"></div></td></tr><%
rs.movenext
wend
rs.close
set rs=nothing
%></table></td></tr></table><input name="inp_readflag" type="hidden" id="inp_readflag" value="<%= readflag %>">
	  <%
set rs=server.createobject("adodb.recordset")
sql="select top 5 * from admin_liuyan where frompeple='"&session("username")&"'or topeple='"&session("username")&"'order by times desc "
rs.open sql,conn,1,1
readflag = True
if not rs.eof then
%><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"><tr><td><div align="center" class="style2"><table width="100%" border="0" cellpadding="0" cellspacing="0" background="img/33.JPG"><tr><td width="82%"><div align="center" class="style2"><div align="left">&nbsp;<span class="style4">&nbsp;最新留言</span></div></div></td><td width="10%"><a href="news_ADD.asp">添加留言</a></td><td width="8%"><a href="liuyan_look.asp" target="main2"><font color="#0000FF">更多...</font></a></td></tr></table></div></td></tr><tr><td height="23"><table id="tb_guest" width="100%" height="18" border="0" align="center" cellpadding="0" cellspacing="1" bordercolor="#999999" bgcolor="#CCCCCC"><%
While not rs.eof
%><tr bgcolor="#ffffff" onMouseOver="this.bgColor='#FF9966'" onMouseOut="this.bgColor='#FFFFFF'"><td width="496" height="18"><div align="left">　<a id="linkGuestTitle_<%= rs("id") %>" href="javascript:openEditScript('admin/liuyan_list.asp?from=main&id=<%= rs("id") %>',780,370)" <%
UserReadFlag=rs("ReadFlag")
if UserReadFlag=0 and rs("frompeple")<>session("username") then
readflag=False
response.write "class=""Red_B_Text"""
end if
%>><%= left(replace(rs("title"),"<BR>","&nbsp;"),50) %>...</a></div><div align="center"></div></td><td width="162"><%= rs("times") %></td><%
if rs("topeple")=session("username") then
%><td width="137"> 留言者：<%= rs("frompeple") %><%
elseif rs("frompeple")=session("username") then
%><td width="138"> 我对<%= rs("topeple") %>的留言
                  <%
end if
%><div align="center"></div><div align="center"></div></td></tr><%
rs.movenext
wend
%></table></td></tr></table><%
end if
rs.close
set rs=nothing
%><input name="inp_guest_readflag" type="hidden" id="inp_guest_readflag" value="<%= readflag %>">
	      <%
set rs=server.CreateObject("adodb.recordset")
rs.open "select * from  kaoqing where peplename='"&session("username")&"' and times=#"&date&"#" ,conn,1,1
%><table width="100%"  border="0" cellspacing="0" cellpadding="0"><tr><td background="img/33.JPG">&nbsp;&nbsp;[<font color="#0000FF"><a href="kaoqin.asp">历史记录</a></font>] 工资以本考勤表为准, 考勤结合工作签名等, 所以公司人员都要互相监督才能正常考勤. </td></tr></table><table width="100%"  border="0" cellspacing="0" cellpadding="0"><tr><td><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="3" bgcolor="#CCCCCC"><tr><td height="49" valign="bottom" bgcolor="#efefef"><table width="791" height="31"  border="0" cellpadding="0" cellspacing="0"><tr><td height="31"><table width="100%" height="31"  border="0" cellpadding="0" cellspacing="0"><tr><td><form name="form1" method="post" action=""><div align="left"> &nbsp;&nbsp;
                            <input type="radio" name="times" value="1"
		<%
if not rs.eof then
if not isnull(rs("time1")) then
...
%>>
		...
		<%
if not rs.eof then
if not isnull(rs("time4")) then
response.Write "disabled"
end if
end if
%>>
                      下午下班 &nbsp;
                      <input type="radio" name="times" value="5"
		<%
if not rs.eof then
if not isnull(rs("time5")) then
response.Write "disabled"
end if
end if
%>>
                      晚上上班 &nbsp;
                      <input type="radio" name="times" value="6"
		<%
if not rs.eof then
if not isnull(rs("time6")) then
response.Write "disabled"
end if
end if
%>>
                      晚上下班&nbsp;&nbsp;&nbsp;
                      <input type="submit" name="Submit" value="考勤" onClick="return check_read_flag();">
                      &nbsp;&nbsp; [ <a href="javascript:openwindow('admin/queqin_sm.asp',700,400)">缺勤说明 </a>] </div></form></td></tr></table></td></tr></table></td></tr></table></td></tr></table><%
rs.close
set rs=nothing
set rs=server.CreateObject("adodb.recordset")
rs.open "select s.* from shejixiadan s inner join kehu k on s.kehu_id=k.id where not isnull(s.times) and datevalue(s.times)=#"&date()&"# and not isnull(s.times) and (s.userid='"&session("userid")&"' or s.userid2='"&session("userid")&"' or s.userid3='"&session("userid")&"')"&CheckShareShopToSql()&" order by s.times desc",conn,1,1
%><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"><tr><td><div align="center" class="style2"><table width="100%" border="0" cellpadding="0" cellspacing="0" background="img/33.JPG"><tr><td width="92%"><div align="center" class="style2"><div align="left">&nbsp;<span class="style4">&nbsp;</span>今日下单&nbsp;&nbsp;[点击单号进入客户控制面版]</div></div></td><td width="8%"><a href="caiwu.asp" target="main2"><font color="#0000FF">更多..</font></a></td></tr></table></div></td></tr><tr><td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC"><%
if rs.eof then
%><tr bgcolor="#FFFFFF"><td height="18" colspan="4"><div align="center"><span class="STYLE10">今日暂时无下单记录</span></div></td></tr><%
else
%><tr bgcolor="#99FFFF"><td height="18" bgcolor="#CCCCCC"><div align="center" class="STYLE10">系统单号/手动单号</div></td><td bgcolor="#CCCCCC"><div align="center" class="STYLE10">顾客姓名</div></td><td bgcolor="#CCCCCC"><div align="center" class="STYLE10">联系电话</div></td><td bgcolor="#CCCCCC"><div align="center" class="STYLE10">套系</div></td></tr><%
while not rs.eof
%><tr bgcolor="#FFFFFF" onMouseOver="this.bgColor='#FF9966'" onMouseOut="this.bgColor='#FFFFFF'"><td height="18"><div align="center"><a href="javascript:openEditScript('kehu_mianban.asp?id=<%= rs("id") %>',450,500)">
			  <%
response.Write rs("id")
if rs("danhao")<>"" then
response.Write "/"&rs("danhao")
else
response.Write "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
end if
%></a></div></td><td height="18"><div align="center"><a href="javascript:openEditScript('ckkh.asp?id=<%= rs("kehu_id") %>',800,350)">
                <%
set rs4=server.CreateObject("adodb.recordset")
rs4.open "select * from kehu where id="&rs("kehu_id")&"",conn,1,1
response.write rs4("lxpeple")
if rs4("lxpeple2")<>"" and not isnull(rs4("lxpeple2")) then
response.write " / "&rs4("lxpeple2")
end if
rs4.close()
set rs4=nothing
%></a><a href="javascript:openEditScript('ckkh.asp?id=<%= rs("kehu_id") %>',800,350)"></a></div></td><td><div align="center"><%= GetTelNo(conn.execute("select telephone from kehu where id="&rs("kehu_id"))(0)) %></div></td><td><div align="center"><%= conn.execute("select companytype from companytype where id="&conn.execute("select type from jixiang where id="&rs("jixiang")&"")(0)&"")(0) %>-<%= conn.execute("select jixiang from jixiang where id="&rs("jixiang")&"")(0) %></div></td></tr><%
rs.movenext
wend
end if
%></table></td></tr></table><%
...
set rs=nothing
'
if instr(session("level2"),"109")>0 then
dim flowsql
flowsql=clsWorkflow.TableBuilder("xp", "", "", "", 2, "", "", "", "", false)
if not isnull(flowsql) then
set rs=server.CreateObject("adodb.recordset")
rs.open flowsql,conn,1,1
%><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"><tr><td><div align="center" class="style2"><table width="100%" border="0" cellpadding="0" cellspacing="0" background="img/33.JPG"><tr><td width="92%"><div align="center" class="style2"><div align="left">&nbsp;<span class="style4">&nbsp;最近三天<span class="style9">选片流程</span>审核&nbsp;&nbsp;[点击单号进入客户控制面版]</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<A href="kanjian.asp?action=ap">未安排时间</A></div></div></td><td width="8%"><a href="kanjian.asp?action=wc" target="main2"><font color="#0000FF">更多..</font></a></td></tr></table></div></td></tr><tr><td height="23"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC"><%
if rs.eof or StepControl=1 then
%><tr bgcolor="#FFFFFF"><td height="13" colspan="6"><div align="center"><span class="style1">当前无选片记录</span></div></td></tr><%
else
%><tr bgcolor="#99FFFF"><td height="13" bgcolor="#CCCCCC"><div align="center" class="STYLE10">单号/手动单号</div></td><td bgcolor="#CCCCCC"><div align="center" class="STYLE10">姓名</div></td><td bgcolor="#CCCCCC"><div align="center" class="STYLE10">联系电话</div></td><td bgcolor="#CCCCCC"><div align="center" class="STYLE10">摄影师</div></td><td bgcolor="#CCCCCC"><div align="center" class="STYLE10">电子签名流程</div></td><td bgcolor="#CCCCCC"><div align="center" class="STYLE10">选片日期</div></td></tr><%
while not rs.eof
%><tr bgcolor="#FFFFFF" onMouseOver="this.bgColor='#FF9966'" onMouseOut="this.bgColor='#FFFFFF'"><td height="18"><div align="center"><a href="javascript:openEditScript('kehu_mianban.asp?id=<%= rs("id") %>',450,500)">
              <%
response.Write rs("id")
...
%></a></div></td><td height="18"><div align="center"><div align="center"><a href="javascript:openEditScript('ckkh.asp?id=<%= rs("kehu_id") %>',800,350)">
                <%
set rs4=server.CreateObject("adodb.recordset")
rs4.open "select * from kehu where id="&rs("kehu_id")&"",conn,1,1
response.write rs4("lxpeple")
...
rs4.close()
set rs4=nothing
%></a></div></div></td><td><div align="center"><%= GetTelNo(conn.execute("select telephone from kehu where id="&rs("kehu_id")&"")(0)) %></div></td><td><div align="center"><%
set rs5=conn.execute("select * from xiadan where xiangmu_id="&rs("id")&" and type=4")
if rs5.eof then
response.Write "未分派"
else
response.Write conn.execute("select peplename from yuangong where username='"&rs5("userid")&"'")(0)&"&nbsp;&nbsp;"
end if
rs5.close
set rs5=nothing
%></div></td><td><div align="center"><%
res=clsWorkflow.GetNextStep(rs("id"), currentWork)
if instr(res(0),currentWork)>0 or not res(2) then
response.write "<a href='xiadan2.asp?id="&rs("id")&"&action=edit'>确认选片</a>"
else
response.write "催"&res(1)&"确认"
end if
%></div></td><td>&nbsp;&nbsp;<%
response.Write rs("kj_time")&"&nbsp;&nbsp;"&rs("kj")
%></td></tr><%
rs.movenext
wend
end if
...
currentWork="kb"
flowsql=clsWorkflow.TableBuilder(currentWork, "", "", "", 100, "", "", "", "", false)
if not isnull(flowsql) then
set rs=server.CreateObject("adodb.recordset")
rs.open flowsql,conn,1,1
%><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"><tr><td><div align="center" class="style2"><table width="100%" border="0" cellpadding="0" cellspacing="0" background="img/33.JPG"><tr><td width="92%"><div align="center" class="style2"><div align="left">&nbsp;<span class="style4">&nbsp;最近<span class="style9">看版流程</span>审核&nbsp;&nbsp;[点击单号进入客户控制面版]</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<STRONG><A href="admin/xiaogao.asp?action=no_ap">未安排时间</A></STRONG></div></div></td><td width="8%"><a href="admin\xiaogao.asp" target="main2"><font color="#0000FF">更多..</font></a></td></tr></table></div></td></tr><tr><td height="23"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC"><%
if rs.eof or StepControl=1 then
%><tr bgcolor="#FFFFFF"><td height="13" colspan="7"><div align="center"><span class="style1">当前无选片记录</span></div></td></tr><%
else
%><tr bgcolor="#99FFFF"><td height="13" bgcolor="#CCCCCC"><div align="center" class="STYLE10">单号/手动单号</div></td><td bgcolor="#CCCCCC"><div align="center" class="STYLE10">姓名</div></td><td bgcolor="#CCCCCC"><div align="center" class="STYLE10">联系电话</div></td><td bgcolor="#CCCCCC"><div align="center" class="STYLE10">设计师</div></td><td width="10%" align="center" bgcolor="#CCCCCC"><div align="center" class="STYLE17">看版</div></td><td bgcolor="#CCCCCC"><div align="center" class="STYLE10">电子签名流程</div></td><td bgcolor="#CCCCCC"><div align="center" class="STYLE10">看版日期</div></td></tr><%
while not rs.eof
if isnull(rs("lc_xp2")) then
%><tr bgcolor="#FFFFFF" onMouseOver="this.bgColor='#FF9966'" onMouseOut="this.bgColor='#FFFFFF'"><td height="18"><div align="center"><a href="javascript:openEditScript('kehu_mianban.asp?id=<%= rs("id") %>',450,500)">
                  <%
response.Write rs("id")
if rs("danhao")<>"" then
...
set rs4=nothing
%></a></div></div></td><td><div align="center"><%= GetTelNo(conn.execute("select telephone from kehu where id="&rs("kehu_id"))(0)) %></div></td><td><div align="center"><%
if isnull(rs("sj_name")) or rs("sj_name")="" then
response.Write "未分派"
else
...
response.write "<font color=red>客户看版</font>"
end if
%></td><td><div align="center"><%
res=clsWorkflow.GetNextStep(rs("id"), currentWork)
if instr(res(0),currentWork)>0 or not res(2) then
%><a href="javascript:openwindow('admin/fenpei.asp?action=xg&level=1&id=<%= rs("id") %>',800,600)">确认工作签名</a><a href="javascript:openEditScript('admin/fabu.asp?id=<%= rs("id") %>',800,350)" title="对设计师 <%= rs("sj_name") %> 留言">留言</a><%
else
response.write "催"&res(1)&"确认"
end if
%></div></td><td> &nbsp; &nbsp;<%
...
if instr(session("level2"),"108")>0 then
currentWork="sy"
flowsql=clsWorkflow.TableBuilder(currentWork, "", "", "", 2, "", "", "", "", false)
if not isnull(flowsql) then
set rs=server.CreateObject("adodb.recordset")
rs.open flowsql,conn,1,1
%><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"><tr><td><div align="center" class="style2"><table width="100%" border="0" cellpadding="0" cellspacing="0" background="img/33.JPG"><tr><td width="92%"><div align="center" class="style2"><div align="left">&nbsp;<span class="style4">&nbsp;最近三天</span>摄影流程 &nbsp;&nbsp;<span class="style4">[点击单号进入客户控制面版]</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<A href="sy_hz.asp?action=ap">未安排时间</A></div></div></td><td width="8%"><a href="kan_qu.asp?action=hz" target="main2"><font color="#0000FF">更多..</font></a></td></tr></table></div></td></tr><tr><td><table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC"><%
if rs.eof or StepControl=1 then
%><tr bgcolor="#FFFFFF"><td colspan="7"><div align="center"><span class="style1">当前无拍照化妆记录</span></div></td></tr><%
else
%><tr bgcolor="#99FFFF"><td bgcolor="#CCCCCC"><div align="center" class="STYLE10">系统单号/手动单号</div></td><td bgcolor="#CCCCCC"><div align="center" class="STYLE10">姓名</div></td><td bgcolor="#CCCCCC"><div align="center" class="STYLE10">联系电话</div></td><td bgcolor="#CCCCCC"><div align="center" class="STYLE10"><%= GetDutyName(5) %></div></td><td align="center" bgcolor="#CCCCCC"><span class="STYLE10">拍照化妆时间</span></td><td align="center" bgcolor="#CCCCCC"><div align="center" class="STYLE10">化妆/摄影</div></td><td align="center" bgcolor="#CCCCCC">确认签名</td></tr><%
While not rs.eof
%><tr bgcolor="#FFFFFF" onMouseOver="this.bgColor='#FF9966'" onMouseOut="this.bgColor='#FFFFFF'"><td><div align="center"><a href="javascript:openEditScript('kehu_mianban.asp?id=<%= rs("id") %>',450,500)">
              <%
response.Write rs("id")
if rs("danhao")<>"" then
response.Write "/"&rs("danhao")
...
%></a></div></td><td><div align="center"><a href="javascript:openEditScript('ckkh.asp?id=<%= rs("kehu_id") %>',800,350)">
              <%
set rs4=server.CreateObject("adodb.recordset")
rs4.open "select * from kehu where id="&rs("kehu_id")&"",conn,1,1
response.write rs4("lxpeple")
...
rs4.close()
set rs4=nothing
%></a></div></td><td><div align="center"><%= GetTelNo(conn.execute("select telephone from kehu where id="&rs("kehu_id")&"")(0)) %></div></td><td><div align="center"><%
set rs3=server.CreateObject("adodb.recordset")
rs3.open "select * from xiadan where xiangmu_id="&rs("id")&" and type="&"5"&"",conn,1,1
if rs3.eof then
response.Write "未分派"
else
response.Write conn.execute("select peplename from yuangong where username='"&rs3("userid")&"'")(0)&"&nbsp;&nbsp;"
end if
rs3.close
set rs3=nothing
%></div></td><td>&nbsp;&nbsp;<%
response.Write rs("pz_time")
response.Write "&nbsp;&nbsp;"&rs("pz")
%></td><td><div align="center"><%
if not isnull(rs("lc_cp")) and not isnull(rs("lc_hz")) then
response.write "已完成"
else
response.write "未完成"
end if
...
res=clsWorkflow.GetNextStep(rs("id"), currentWork)
if instr(res(0),currentWork)>0 or not res(2) then
%><a href="javascript:openEditScript('admin/CSShootWork.asp?id=<%= rs("id") %>',800,550)">确认签名</a><%
else
response.write "催"&res(1)&"确认"
end if
%></td></tr><%
...
if instr(session("level2"),"110")>0 then
flowsql=clsWorkflow.TableBuilder("qj", "", "", "", 2, "", "", "", "", false)
if not isnull(flowsql) then
set rs=server.CreateObject("adodb.recordset")
rs.open flowsql,conn,1,1
%><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"><tr><td><div align="center" class="style2"><table width="100%" border="0" cellpadding="0" cellspacing="0" background="img/33.JPG"><tr><td width="92%"><div align="center" class="style2"><div align="left">&nbsp;<span class="style4">&nbsp;最近三天<span class="style9">取件客户</span>&nbsp;[点击单号进入客户控制面版]</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<A href="qujian2.asp?action=ap">未安排时间</A></div></div></td><td width="8%"><a href="qujian2.asp?action=wc" target="main2"><font color="#0000FF">更多..</font></a></td></tr></table></div></td></tr><tr><td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC"><form name="form_qj" action="right.asp?action=wc2" method="post"><%
if rs.eof or StepControl=1 then
%><tr bgcolor="#FFFFFF"><td height="18" colspan="6"><div align="center"><span class="style1">当前无取件记录</span></div></td></tr><%
else
%><tr bgcolor="#99FFFF"><td height="18" bgcolor="#CCCCCC"><div align="center" class="STYLE10">系统单号/手动单号</div></td><td height="18" bgcolor="#CCCCCC"><div align="center" class="STYLE10">姓名</div></td><td bgcolor="#CCCCCC"><div align="center" class="STYLE10">联系电话</div></td><td bgcolor="#CCCCCC"><div align="center" class="STYLE10">套系</div></td><td bgcolor="#CCCCCC"><div align="center" class="STYLE10">电子签名流程</div></td><td bgcolor="#CCCCCC"><div align="center" class="STYLE10">取件日期</div></td></tr><%
dim fail
while not rs.eof
fail=0
finalmoney = FinalMoneySum(rs("id"),False)
if finalmoney<>0 then
fail=-1
elseif not CheckTaskEnd(rs("id")) or not CheckQujianIsComplete(rs("id")) then
fail=1
end if
%><tr bgcolor="#FFFFFF" onMouseOver="this.bgColor='#FF9966'" onMouseOut="this.bgColor='#FFFFFF'"><td height="18">&nbsp;<input name="qj_id" type="checkbox" id="qj_id" value="<%= rs("id") %>" onClick="checkItem(this, 'chk_qj_all')"<%
if fail=-1 then response.write " disabled"
if session("level")<>10 then response.Write " style='display:none'"
%>><a href="javascript:openEditScript('kehu_mianban.asp?id=<%= rs("id") %>',450,500)"><%
response.Write rs("id")
if rs("danhao")<>"" then
response.Write "/"&rs("danhao")
else
...
%></a></td><td><div align="center"><a href="javascript:openEditScript('ckkh.asp?id=<%= rs("kehu_id") %>',800,350)">
              <%
set rs4=server.CreateObject("adodb.recordset")
rs4.open "select * from kehu where id="&rs("kehu_id")&"",conn,1,1
response.write rs4("lxpeple")
...
rs4.close()
set rs4=nothing
%></a></div></td><td><div align="center"><%= GetTelNo(conn.execute("select telephone from kehu where id="&rs("kehu_id")&"")(0)) %></div></td><td><div align="center"><%= GetFieldDataBySQL("select jixiang from jixiang where id="&rs("jixiang"),"str","N/A") %></div></td><td><div align="center"><%
'
'
'
'
%><a href="right.asp?action=wc2&id=<%= rs("id") %>" onClick="return confirm('确定已验件,客人已全部取件完成了吗？')">
             
              <%
if fail=-1 then
response.write "<font color=red><b>确认取件</b></font>"
elseif fail=1 then
response.write "<font color=blue><b>确认取件</b></font>"
else
response.write "确认取件"
end if
%></a><%
...
if session("level")<>10 then response.Write "style='display:none'"
%>>
      <td colspan="12">&nbsp;<input name="chk_qj_all" type="checkbox" id="chk_qj_all" value="all" onClick="checkAll(this, 'qj_id')">
        全选&nbsp;
        <input type="submit" name="Submit" value="批量完成" onClick="return act_fenpei('form_qj','qj_id','qj')"></td></tr></form></table></td></tr></table><%
rs.close
set rs=nothing
end if
end if
...
'
set rs=server.CreateObject("adodb.recordset")
rs.open "select s.* from shejixiadan s inner join kehu k on s.kehu_id=k.id where s.hz_time<=#"&date+2&"# and isnull(s.hz_userid) and (s.wc_name='' or isnull(s.wc_name)) and isnull(s.c_wc) and s.shejiwancheng=0"&CheckShareShopToSql()&" order by s.hz_time asc",conn,1,1
%><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"><tr><td><div align="center" class="style2"><table width="100%" border="0" cellpadding="0" cellspacing="0" background="img/33.JPG"><tr><td width="92%"><div align="center" class="style2"><div align="left">&nbsp;<span class="style4">&nbsp;最近三天结婚化妆</span> &nbsp;&nbsp;[点击单号进入客户控制面版]&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<A href="kan_qu.asp?action=hz&action2=ap">未安排时间</A></div></div></td><td width="8%"><a href="kan_qu.asp?action=hz" target="main2"><font color="#0000FF">更多..</font></a></td></tr></table></div></td></tr><tr><td><table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC"><%
if rs.eof or StepControl=1 then
%><tr bgcolor="#FFFFFF"><td colspan="5"><div align="center"><span class="style1">当前无结婚化妆记录</span></div></td></tr><%
else
%><tr bgcolor="#99FFFF"><td bgcolor="#CCCCCC"><div align="center" class="STYLE11">系统单号/手动单号</div></td><td bgcolor="#CCCCCC"><div align="center" class="STYLE11">顾客姓名</div></td><td bgcolor="#CCCCCC"><div align="center" class="STYLE11">联系电话</div></td><td bgcolor="#CCCCCC"><div align="center" class="STYLE11"><%= GetDutyName(5) %></div></td><td bgcolor="#CCCCCC"><div align="center" class="STYLE11">结婚化妆时间</div></td></tr><%
While not rs.eof
%><tr bgcolor="#FFFFFF" onMouseOver="this.bgColor='#FF9966'" onMouseOut="this.bgColor='#FFFFFF'"><td><div align="center"><a href="javascript:openEditScript('kehu_mianban.asp?id=<%= rs("id") %>',450,500)">
            <%
response.Write rs("id")
...
set rs4=nothing
%></a></div></td><td><div align="center"><%= GetTelNo(conn.execute("select telephone from kehu where id="&rs("kehu_id")&"")(0)) %></div></td><td><div align="center"><%
if not isnull(rs("hz_userid")) then
response.Write conn.execute("select peplename from yuangong where username='"&rs("hz_userid")&"'")(0)
else
response.Write "未分配"&GetDutyName(5)
end if
%></div></td><td><div align="left"> &nbsp;
                <%
response.Write rs("hz_time")
response.Write "&nbsp;&nbsp;"&rs("hz")
%></div></td></tr><%
rs.movenext
wend
end if
...
set rs=nothing
set rs=server.CreateObject("adodb.recordset")
rs.open "select * from save_money m  where not isnull(m.times) and times>=#"&date&"# and m.xiangmu_id in (select s.id from shejixiadan s inner join kehu k on s.kehu_id=k.id where (s.userid='"&session("userid")&"' or s.userid2='"&session("userid")&"' or s.userid3='"&session("userid")&"')"&CheckShareShopToSql()&") order by m.times",conn,1,1
%><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"><tr><td><div align="center" class="style2"><table width="100%" border="0" cellpadding="0" cellspacing="0" background="img/33.JPG"><tr><td width="37%"><div align="center" class="style2"><div align="left">&nbsp;<span class="style4">&nbsp;<span class="style2">今日收款&nbsp;&nbsp;[点击单号进入客户控制面版]</span></span></div></div></td><td width="55%"><span class="style2">总金额：<font color=blue><%
money111=conn.execute("select sum(m.money) from save_money m where not isnull(m.times) and times>=#"&date&"# and m.xiangmu_id in (select s.id from shejixiadan s inner join kehu k on s.kehu_id=k.id where (s.userid='"&session("userid")&"' or s.userid2='"&session("userid")&"' or s.userid3='"&session("userid")&"')"&CheckShareShopToSql()&")")(0)
if isnull(money111) then money111=0
response.Write money111
%></font><span class="style6">元</span></span></td><td width="8%"><a href="rc_caiwu.asp" target="main"><font color="#0000FF">更多..</font></a></td></tr></table></div></td></tr><tr><td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC"><%
if rs.eof or StepControl=1 then
%><tr bgcolor="#FFFFFF"><td height="18" colspan="4"><div align="center" class="style1">今日暂时无收款记录</div></td></tr><%
else
%><tr bgcolor="#99FFFF"><td height="18" bgcolor="#CCCCCC"><div align="center" class="STYLE11">系统单号/手动单号</div></td><td bgcolor="#CCCCCC"><div align="center" class="STYLE11">顾客姓名</div></td><td bgcolor="#CCCCCC"><div align="center" class="STYLE11">金额</div></td><td bgcolor="#CCCCCC"><div align="center" class="STYLE11">时间</div></td></tr><%
while not rs.eof
%><tr bgcolor="#FFFFFF" onMouseOver="this.bgColor='#FF9966'" onMouseOut="this.bgColor='#FFFFFF'"><td height="18"><div align="center"><a href="javascript:openEditScript('kehu_mianban.asp?id=<%= rs("id") %>',450,500)">
                </a><a href="javascript:openEditScript('kehu_mianban.asp?id=<%= rs("xiangmu_id") %>',450,500)">
                <%
response.Write rs("xiangmu_id")
if conn.execute("select danhao from shejixiadan where id="&rs("xiangmu_id")&"")(0)<>"" then
response.Write "/"&conn.execute("select danhao from shejixiadan where id="&rs("xiangmu_id")&"")(0)
else
response.Write "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
end if
%></a></div></td><td height="18"><div align="center"><%
set rs4=server.CreateObject("adodb.recordset")
rs4.open "select * from kehu where id="&conn.execute("select kehu_id from shejixiadan where id="&rs("xiangmu_id")&"")(0),conn,1,1
response.write rs4("lxpeple")
if rs4("lxpeple2")<>"" and not isnull(rs4("lxpeple2")) then
response.write " / "&rs4("lxpeple2")
end if
rs4.close()
set rs4=nothing
%></div></td><td><div align="center"><font color="#FF0000"><%= rs("money") %></font>(元)</div></td><td><div align="center"><p><%= rs("times") %></p></div></td></tr><%
rs.movenext
wend
end if
%></table></td></tr></table><%
...
set rs=nothing
set rs=server.CreateObject("adodb.recordset")
rs.open "select r.* from richeng r inner join yuangong k on r.userid=k.username where r.times>=#"&date()&"# and r.times<=#"&date()+2&"# and r.userid='"&session("userid")&"'"&CheckShareShopToSql()&" order by r.shijian asc",conn,1,1
%><table width="100%" border="0" cellpadding="0" cellspacing="1" bordercolor="#999999" bgcolor="#CCCCCC"><tr><td height="21" colspan="5"><div align="center" class="style2"><table width="100%" height="20" border="0" cellpadding="0" cellspacing="0" background="img/33.JPG"><tr><td width="66%"><div align="left"><span class="style3"><a href="javascript:openwindow('print.asp',750,450)"></a>&nbsp;&nbsp;<span class="style4">最近三天客服记录</span></span></div></td><td width="26%"><span class="style3"><a href="javascript:openwindow('print.asp',750,450)">　</a>&nbsp;&nbsp;
              </span></td><td width="8%"><a href="llrc.asp" target="main2"><font color="#0000FF">更多..</font></a></td></tr></table></div></td></tr><%
if rs.eof or StepControl=1 then
%><tr bordercolor="#0000FF" bgcolor="#FFFFFF"><td height="18" colspan="5"><div align="center"><span class="STYLE10">暂时无客服记录</span></div></td></tr><%
else
%><tr bordercolor="#0000FF" bgcolor="#99FFFF"><td height="18" bgcolor="#CCCCCC"><div align="left">　客服标题</div></td><td bgcolor="#CCCCCC"><div align="center">顾客姓名</div></td><td bgcolor="#CCCCCC"><div align="center">手机号码</div></td><td bgcolor="#CCCCCC"><div align="center">客服安排时间</div></td><td bgcolor="#CCCCCC"><div align="center">添加客服</div></td></tr><%
while not rs.eof
%><tr bgcolor="#FFFFFF" <%
if y mod 2=0 then
response.Write "bgcolor='#CCCCFF'"
else
response.Write "bgcolor='#FFCC99'"
end if
%>>
        <td height="18"><div align="left"> &nbsp; <a href="admin/llrc3.asp?id=<%= rs("kehu_id") %>" >
              <%
if rs("title")="管理员日程委派!" then
response.Write "<font color=red>"&rs("title")&"</font>"
else
...
%></a><%
if rs("import")=1 then
response.Write "<font color=blue>[重要]</font>"
end if
if rs("times")>=date then
%><a href="richeng_xiugai.asp?id=<%= rs("id") %>"><font color=red>修改</font></a><%
end if
%></div></td><%
set rs4=server.CreateObject("adodb.recordset")
rs4.open "select * from kehu where id="&rs("kehu_id")&"",conn,1,1
xmid=getfielddatabysql("select id from shejixiadan where kehu_id="&rs4("id")&" order by id desc","int",0)
if xmid=0 then
khurl="admin/ckkh.asp?id="&rs4("id")
else
khurl="kehu_mianban.asp?id="&xmid
end if
%><td><div align="center"><a href="javascript:openEditScript('<%= khurl %>',800,350)"><%
response.write rs4("lxpeple")
if rs4("lxpeple2")<>"" and not isnull(rs4("lxpeple2")) then
response.write " / "&rs4("lxpeple2")
end if
%></a></div></td><td><div align="center"><%= GetTelNo(rs4("telephone")) %></div></td><%
rs4.close
set rs4=nothing
%><td><div align="center"><%= rs("times") %></div></td><td><div align="center"><a href="tjrc3.asp?id=<%= rs("kehu_id") %>">添加</a></div></td></tr><%
rs.movenext
i=i+1
wend
end if
...
set rs=server.CreateObject("adodb.recordset")
sql = GetProjectReportSQL(session("userid"),session("username"))
rs.open sql,conn,1,1
%><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"><tr><td><div align="center" class="style2"><table width="100%" border="0" cellpadding="0" cellspacing="0" background="img/33.JPG"><tr><td width="92%"><div align="center" class="style2"><div align="left">&nbsp;<span class="style4">&nbsp;后期订单交流</span></div></div></td><td width="8%"></td></tr></table></div></td></tr><tr><td height="23"><table id="tb_message" width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC"><%
readflag=True
if  rs.eof then
%><tr bgcolor="#FFFFFF"><td height="18" colspan="5"><div align="center"><span class="STYLE10">当前暂无订单交流记录</span></div></td></tr><%
else
%><tr bgcolor="#99FFFF"><td width="13%" height="18" bgcolor="#CCCCCC"><div class="STYLE10">&nbsp;系统单号</div></td><td bgcolor="#CCCCCC"><div class="STYLE10">&nbsp;留言内容</div></td><td bgcolor="#CCCCCC"><div class="STYLE10">&nbsp;留言时间</div></td><td width="10%" bgcolor="#CCCCCC"><div class="STYLE10">&nbsp;留言者</div></td><td width="10%" bgcolor="#CCCCCC"><div class="STYLE10">&nbsp;接收者</div></td></tr><%
while not rs.eof
%><tr bgcolor="#FFFFFF" onMouseOver="this.bgColor='#FF9966'" onMouseOut="this.bgColor='#FFFFFF'"><td height="18">&nbsp;<a href="javascript:openEditScript('kehu_mianban.asp?id=<%= rs("xiangmu_id") %>',450,500)">
          <%
response.Write rs("xiangmu_id")
%></a></td><td height="18">&nbsp;<a id="linkMessageTitle_<%= rs("id") %>" href="javascript:openEditScript('admin/baobiaolist.asp?from=main&id=<%= rs("xiangmu_id") %>',450,500)" <%
pname = GetFieldDataBySQL("select peplename from yuangong where username='"&rs("userid")&"'","str",null)
tname = GetFieldDataBySQL("select peplename from yuangong where username='"&rs("topeple")&"'","str",null)
UserReadFlag=rs("ReadFlag")
if UserReadFlag=0 and rs("topeple")=session("userid") And rs("topeple")<>"所有人" then
readflag=False
response.write "class=""Red_B_Text"""
end if
%>><%= left(replace(rs("baobiao"),"<BR>","&nbsp;"),50) %>...</a></td><td height="18">&nbsp;<%= rs("times") %></td><td>&nbsp;
          <%
...
%></td><td>&nbsp;
          <%
if rs("topeple")="所有人" then
response.write  "所有人"
else
if isnull(tname) then
response.write "N/A"
else
if rs("topeple")=session("userid") then
response.write "我"
else
...
rs.close
set rs=Nothing
%></table></td></tr></table><input name="inp_mes_readflag" type="hidden" id="inp_mes_readflag" value="<%= readflag %>">
</body></html>