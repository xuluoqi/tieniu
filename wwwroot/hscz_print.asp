...
orderid = request("id")
set rs=server.CreateObject("adodb.recordset")
rs.open "SELECT * FROM chuzhu_jilu where id="&orderid,conn,1,1
%><table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0"><tr><td> 单号：<%= rs("orderNo") %>&nbsp;&nbsp;&nbsp;客户：
    <%
...
set rs4=nothing
%>
    &nbsp;&nbsp;时间：<%= now() %>&nbsp;&nbsp; &nbsp;<%= getPrintString(rs("kehu_id")) %></td></tr></table><table width="98%"  border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC"><tr bgcolor="#efefef"><td bgcolor="#FFFFFF">出租日期：<%= rs("outdate") %>&nbsp;<%
sjd=rs("cpamorpm")
if sjd=0 then
response.write "上午"
elseif sjd=1 then
...
%>    &nbsp;&nbsp;&nbsp;&nbsp; 押金：<%= rs("FactMoney") %> 元</td></tr><tr bgcolor="#FFFFFF"><td height="80" align="left" valign="top"><table width="66%"  border="0" cellpadding="0" cellspacing="0"><tr><td colspan="4" style="line-height:25px"><%
...
rsgroup.open "select distinct groupname from chuzhu_details where orderid="&orderid,conn,1,1
do while not rsgroup.eof
response.write "<td width='50%' style=""line-height:25px"">"
rsdetails.open "select * from chuzhu_details where orderid="&orderid&" and groupname='"&rsgroup("groupname")&"' order by IsMainWed desc, id",conn,1,1
do while not rsdetails.eof
if rsdetails("IsMainWed")=1 then
num = conn.execute("select num from huensha where id="&rsdetails("AnnexWedID"))(0)
if not isnull(num) then
mainpro = num&"["&rsdetails("Volume")&"]&nbsp;&nbsp;&nbsp;&nbsp;"
else
mainpro =  "未知项目&nbsp;&nbsp;&nbsp;&nbsp;"
end if
response.write mainpro&"<br>"
else
num = conn.execute("select num from huensha where id="&rsdetails("AnnexWedID"))(0)
if not isnull(num) then
response.write num&"["&rsdetails("Volume")&"]&nbsp;&nbsp;&nbsp;&nbsp;"
else
response.write "未知项目&nbsp;&nbsp;&nbsp;&nbsp;"
end if
end if
...
%><br><br></td></tr><tr><td colspan="4" align="right" style="line-height:25px">(凭本单退礼服押金,如有遗失,请按本影楼操作流程办理)</td></tr><tr><td width="20%" align="left" style="line-height:25px">&nbsp;</td><td align="left" style="line-height:25px">预订签名</td><td align="left" style="line-height:25px">出件签名</td><td align="left" style="line-height:25px">返件签名</td></tr><tr><td align="left" style="line-height:25px">&nbsp;</td><td width="24%" align="left" style="line-height:25px">&nbsp;</td><td width="30%" align="left" style="line-height:25px">押金退还确认</td><td width="26%" align="left" style="line-height:25px">打单：
          <%
