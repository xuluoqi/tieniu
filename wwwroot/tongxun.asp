...
--></style></head><body><p align="center" class="style1"><br><br>
员工通讯录</p><table width="505" height="40" border="0" align="center" cellpadding="0" cellspacing="1" bordercolor="#00CCFF" bgcolor="#CCCCCC" class="xu_kuan"><tr align="left" valign="middle" bgcolor="#99CCFF"><td width="120" class="font" height="21"><div align="center">员工姓名</div></td><td width="273" class="font"><div align="center">个人手机</div></td><td width="108" class="font"><div align="center">员工类型</div></td></tr><%
set rs=server.CreateObject("adodb.recordset")
sql="select * from yuangong where level<>"&"10"&" and isdisabled=0 order by int(level) asc"
rs.open sql,connstr,1,1
while not rs.eof
%><tr align="left" valign="middle" bgcolor="#FFFFFF" onMouseOver="this.bgColor='#fff9e1'" onMouseOut="this.bgColor='#FFFFFF'"><td height="19" align="left" valign="middle" class="font"><div align="center"><%= rs("peplename") %></div></td><td height="19" class="font">&nbsp;<%= rs("telephone") %></td><td align="left" valign="middle" class="font"><div align="center"><%= GetDutyName(rs("level")) %></div></td></tr><%
rs.movenext
wend
rs.close
set rs=nothing
