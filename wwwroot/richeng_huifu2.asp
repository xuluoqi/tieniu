...
</script><link href="admin/zxcss.css" rel="stylesheet" type="text/css"><script language="javascript" src="inc/func.js" type="text/javascript"></script></head><body><%
set rs=server.CreateObject("adodb.recordset")
...
alert("回复日程成功！");location="richeng_huifu.asp?times=<%= request("times") %>"
</script><%
end if
%><p>&nbsp;</p><table width="397" height="359" border="0" align="center" cellpadding="0" cellspacing="0"><form action="" method="post" name="form1" onSubmit="return check()"><tr><td height="54">&nbsp;</td></tr><tr><td height="21"><div align="center">回复日程结果:</div></td></tr><tr><td height="120"><div align="center"><textarea name="huifu" cols="70" rows="8" id="huifu"><%= rs("huifu") %></textarea></div></td></tr><tr><td height="79"><div align="center"><input name="tijiao" type="submit" id="tijiao" value="提交">　　　　      
            
        <input type="button" name="Submit" value="返回" onClick="javascript:history.go(-1)"><input name="id" type="hidden" value="<%= request("id") %>">
        <input type="hidden" name="times" value="<%= request("timed") %>">
