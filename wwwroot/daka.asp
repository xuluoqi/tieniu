...
End Sub
if session("userid")="" then
response.Write "<script>alert('对不起，请先登入！');history.go(-1)</script>"
On Error GoTo 0
Err.Raise 9999
end if
...
response.Write "<script>alert('考勤完成！');location='daka.asp'</script>"
On Error GoTo 0
Err.Raise 9999
end if
set rs=server.CreateObject("adodb.recordset")
rs.open "select * from  kaoqing where peplename='"&session("username")&"' and times=#"&date&"#" ,conn,1,1
%><link href="admin/zxcss.css" rel="stylesheet" type="text/css"><script language="javascript" src="inc/func.js" type="text/javascript"></script><title>普通助理打卡专区</title><table width="100%" height="21"  border="0" align="center" cellpadding="0" cellspacing="0"><tr><td bgcolor="#CCCCCC">&nbsp;&nbsp;<font color="#0000FF"><a href="kaoqin.asp">考勤历史记录</a></font></td></tr></table><table width="100%" height="59"  border="0" align="center" cellpadding="0" cellspacing="0"><tr><td><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="3" bgcolor="#CC6699"><tr><td height="49" bgcolor="#efefef"><table width="638" height="37"  border="0" cellpadding="0" cellspacing="0"><tr><td height="31"><table width="100%" height="31"  border="0" cellpadding="0" cellspacing="0"><tr><td><form name="form1" method="post" action=""><div align="left"> &nbsp;&nbsp;
...
%>>
                      晚上下班&nbsp;&nbsp;&nbsp;                        
                      <input type="submit" name="Submit" value="考勤"></div></form></td></tr></table></td></tr></table></td></tr></table></td></tr></table><%
rs.close
set rs=nothing
%>