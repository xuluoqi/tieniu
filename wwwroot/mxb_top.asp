...
.style3 {color: #FF0000}
--></style><link href="admin/zxcss.css" rel="stylesheet" type="text/css"><script language="javascript" src="inc/func.js" type="text/javascript"></script><script src="../Js/Calendar.js"></script><script language="javascript">
...
</script><link href="../Css/calendar-blue.css" rel="stylesheet"><link href="zxcss.css" rel="stylesheet" type="text/css"></head><body leftmargin="0" topmargin="0"><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0"><tr><form action="mxb_print.asp" target="main11" method="post" name="form1"><td width="73%" height="25">&nbsp;&nbsp;&nbsp;<%
...
%>"></span><span id="sp_time2" style="display:none">选择年份：
...
next
%></select></span><input name="chaxun" type="submit" id="chaxun" value="确定"><input name="type" type="hidden" id="type">        &nbsp; <a href="javascript:void(0);" onClick="javascript:changetype('pd')">自动排单系统</a>&nbsp;&nbsp;<a href="javascript:void(0);" onClick="javascript:changetype('yx')">预设人员安排</a>
&nbsp;&nbsp;<a href="javascript:void(0);" onClick="javascript:changetype('lf')">礼服出租表</a><%
if session("level")<>2 and session("level")<>13 then
%>&nbsp;&nbsp;<a href="javascript:void(0);" onClick="javascript:changetype('job')">工作月报表</a><%
end if
%></td><td width="22%"><input name="predate" type="button" id="predate" value="前一天" onClick="javascript:changedate(-1)"><input name="today" type="button" id="today" value="今天" onClick="javascript:changedate(0)"><input name="nextdate" type="button" id="nextdate" value="后一天" onClick="javascript:changedate(1)"></td><td width="5%"><a href="#" onClick="parent.main11.focus();parent.main11.print();">打印</a></td></form></tr></table></body></html>