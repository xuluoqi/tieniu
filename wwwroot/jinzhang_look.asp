...
End If
End Sub
%><html><head><title>员工管理</title><link href="images/hs.css" rel="stylesheet" type="text/css"><meta http-equiv="Content-Type" content="text/html; charset=gb2312"><style type="text/css"><!--
--></style><link href="admin/zxcss.css" rel="stylesheet" type="text/css"><link href="zxcss.css" rel="stylesheet" type="text/css"><link href="../admin/zxcss.css" rel="stylesheet" type="text/css"><style type="text/css"><!--
.style3 {color: #3366FF}
.style4 {color: #0000FF}
.style5 {color: #0033FF}
.style6 {color: #00CC66}
...
--></style><script language="javascript" src="inc/func.js" type="text/javascript"></script></head><body leftmargin="0" topmargin="0"><p></p><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0"><tr><td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bordercolor="#A4B6D7" bgcolor="#A4B6D7" class="df"><tr bordercolor="#FFFFFF" bgcolor="#99FFFF"><td width="654" height="8"><div align="left"> 　项目:<%= conn.execute("select jixiang from jixiang where id="&conn.execute("select jixiang from shejixiadan where id="&request("id")&"")(0)&"")(0) %></div><div align="left"></div><div align="left"></div><div align="center"></div><div align="center"></div><div align="center"></div></td><td width="144"><div align="center"><%= conn.execute("select times from shejixiadan where id="&request("id")&"")(0) %></div></td></tr><tr bgcolor="#99FFFF"><td height="9" colspan="2">　备注:<%= conn.execute("select beizhu from shejixiadan where id="&request("id")&"")(0) %></td></tr><tr bgcolor="#ECF5FF"><td height="18" colspan="2" bgcolor="#ECF5FF"><table width="100%" border="0" cellpadding="0" cellspacing="0"><tr><td><div align="left">
			  　
			                  <%
set rs2=server.CreateObject("adodb.recordset")
sql="select * from xiadan where xiangmu_id="&request("id")&""
rs2.open sql,conn,1,1
while not rs2.eof
%><a href="sheji_yijian.asp?userid=<%= rs2("userid") %>&id=<%= request("id") %>">对
						 <%
select case conn.execute("select [level] from yuangong where username='"&rs2("userid")&"'")(0)
case 2
response.Write "数码师"
case 4
response.Write "摄影师"
case 5
response.Write GetDutyName(5)
end select
%><font color="#0000FF"><%= conn.execute("select peplename from yuangong where username='"&rs2("userid")&"'")(0) %></font>留言</a>　
                          <%
rs2.movenext
wend
if rs2.recordcount>1 then
%><a href="sheji_yijian.asp?all=1&id=<%= request("id") %>"><span class="style14">对</span>所有人<span class="style14">留言</span></a>　
		<%
end if
rs2.close
set rs2=nothing
set rs1=server.CreateObject("adodb.recordset")
sql="select * from sjs_baobiao where xiangmu_id="&request("id")&" order by times desc"
...
While not rs1.eof
%><tr bgcolor="#FFCCCC"><td width="559">
					&nbsp;&nbsp;
					<%
if rs1("userid")=session("userid") then
if rs1("topeple")="所有人"then
response.Write "<font color=blue>我</font>对<font color=blue>大家</font>留言"
else
response.Write "<font color=blue>我</font>对<font color=blue>"&conn.execute("select peplename from yuangong where username='"&rs1("topeple")&"'")(0)&"</font>意见发表"
end if
else
level=conn.execute("select [level] from yuangong where username='"&rs1("userid")&"'")(0)
if rs1("topeple")="门市" then
select case level
case 2
response.Write "数码师：<font color=blue>"&conn.execute("select peplename from yuangong where username='"&rs1("userid")&"'")(0)&"</font>对<font color=blue>我</font>留言"
case 4
response.Write "摄影师：<font color=blue>"&conn.execute("select peplename from yuangong where username='"&rs1("userid")&"'")(0)&"</font>对<font color=blue>我</font>留言"
case 5
response.Write GetDutyName(5)&"：<font color=blue>"&conn.execute("select peplename from yuangong where username='"&rs1("userid")&"'")(0)&"</font>对<font color=blue>我</font>留言"
end select
else
select case level
case 1
response.Write "门市：<font color=blue>"&conn.execute("select peplename from yuangong where username='"&rs1("userid")&"'")(0)&"</font>对<font color=blue>"&conn.execute("select peplename from yuangong where username='"&rs1("topeple")&"'")(0)&"</font>留言"
case 2
response.Write "数码师：<font color=blue>"&conn.execute("select peplename from yuangong where username='"&rs1("userid")&"'")(0)&"</font>对<font color=blue>"&conn.execute("select peplename from yuangong where username='"&rs1("topeple")&"'")(0)&"</font>留言"
case 3
response.Write "管理员对<font color=blue>"&conn.execute("select peplename from yuangong where username='"&rs1("topeple")&"'")(0)&"</font>留言"
case 4
response.Write "摄影师：<font color=blue>"&conn.execute("select peplename from yuangong where username='"&rs1("userid")&"'")(0)&"</font>对<font color=blue>"&conn.execute("select peplename from yuangong where username='"&rs1("topeple")&"'")(0)&"</font>留言"
case 5
response.Write GetDutyName(5)&"：<font color=blue>"&conn.execute("select peplename from yuangong where username='"&rs1("userid")&"'")(0)&"</font>对<font color=blue>"&conn.execute("select peplename from yuangong where username='"&rs1("topeple")&"'")(0)&"</font>留言"
case 10
if rs1("topeple")="所有人"then
response.Write "管理员对<font color=blue>大家</font>留言"
else
response.Write "管理员对<font color=blue>"&conn.execute("select peplename from yuangong where username='"&rs1("topeple")&"'")(0)&"</font>留言"
end if
end select
...
%></span></td><td width="240"><%= rs1("times") %></td></tr><tr bgcolor="#FFFFFF"><td colspan="2"><table width="795" height="20" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#CCCCFF"><tr><td width="786" bgcolor="#FFFFFF"><%= encode(rs1("baobiao")) %></td></tr></table></td></tr><%
if rs1("huifu")<>""then
%><tr bgcolor="#FFFFFF"><td colspan="2"><span class="style6">　<span class="style9">回复:<%= encode(rs1("huifu")) %></span></span></td></tr><%
end if
rs1.movenext
wend
rs1.close
set rs1=nothing
%></table></div></td></tr></table></td></tr></table></td></tr><tr><td height="64"><div align="center"><input type="submit" name="Submit" value="返回" onClick="javascript:location='caiwu.asp'"></div></td></tr></table></body></html>