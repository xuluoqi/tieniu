...
%><html><head><meta http-equiv="Content-Type" content="text/html; charset=gb2312"><title>通告</title><style type="text/css"><!--
...
.style1 {color: #3300CC}
--></style><script language="javascript" src="inc/func.js" type="text/javascript"></script></head><body><p>&nbsp;</p><table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" class="df"><tr><td height="120"><%
if request("id")<>"" then
set rs2=server.createobject("adodb.recordset")
sql="select * from tonggao  where id="&request("id")&""
rs2.open sql,connstr,1,1
%><table width="699" height="115" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC"><tr bgcolor="#ECF5FF"><td height="33" bgcolor="#FFFFFF"><div align="center"><font color="#0000FF" size="3"><%= rs2("title") %></font></div></td></tr><tr bgcolor="#ECF5FF"><td height="28" bgcolor="#FFFFFF"><div align="center"><%= rs2("times") %></div></td></tr><tr bgcolor="#ECF5FF"><td height="18" bgcolor="#FFFFFF"><table width="97%" height="50" border="0" align="center" cellpadding="0" cellspacing="0"><tr><td height="48"><%= encode(rs2("zhengwen")) %></td></tr></table></td></tr></table><%
end if
rs2.close
set rs2=nothing
%></td></tr></table><table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0"><tr><td height="35"><div align="center"><a href="#" onClick="window.close()">关闭</a></div></td></tr></table></body></html>