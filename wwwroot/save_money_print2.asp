...
End If
End Sub
%><html><head><meta http-equiv="Content-Type" content="text/html; charset=gb2312"><title>预约单打印</title><link href="admin/zxcss.css" rel="stylesheet" type="text/css"><script language="javascript" src="inc/func.js" type="text/javascript"></script><style type="text/css"><!--
.style1 {font-family: Webdings}
--></style></head><body><br><p></p><table width="98%" height="37"  border="0" align="center" cellpadding="0" cellspacing="0"><tr><td width="17%">&nbsp; </td><td width="19%">&nbsp;</td><td width="23%">&nbsp;</td><td width="41%">&nbsp;</td></tr></table><table width="100%" height="702"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC"><tr><td height="65" bgcolor="#FFFFFF"><table width="96%" height="137"  border="0" align="center" cellpadding="0" cellspacing="0"><tr><td height="18" colspan="3">&nbsp;</td></tr><tr><td width="20%" height="20">&nbsp;</td><td width="21%">&nbsp;</td><td width="59%">&nbsp;</td></tr><tr><td height="20" colspan="3">&nbsp;</td></tr><tr><td height="18" colspan="3">&nbsp;</td></tr><tr valign="top"><td height="61" colspan="3">&nbsp;</td></tr></table></td></tr><tr><td height="471" bgcolor="#FFFFFF"><table width="96%" height="471"  border="0" align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td></tr><tr valign="top"><td height="451"><table width="100%" height="155"  border="0" cellpadding="0" cellspacing="0"><tr><td height="121" valign="top">&nbsp;</td></tr><tr><td height="40" valign="top">&nbsp;</td></tr></table><table width="100%" height="50"  border="0" align="center" cellpadding="0" cellspacing="0"><%
set rs1=conn.execute("select distinct(dated) from (select datevalue(times) as dated from fujia where  xiangmu_id="&request("id")&" union  select datevalue(times) as dated from fujia2  where xiangmu_id="&request("id")&")")
i=0
while not rs1.eof
i=i+1
%><tr><td height="40" valign="top">&nbsp; </td><%
rs1.movenext
wend
rs1.close
set rs1=nothing
%></tr></table></td></tr></table></td></tr><tr><td height="26" bgcolor="#FFFFFF"><table width="96%" height="72"  border="0" align="center" cellpadding="0" cellspacing="0"><tr><td height="18">&nbsp;</td></tr><tr><td valign="top"><%
for z=1 to request("px")-1
response.write "<br>"
next
set rs3=conn.execute("select * from save_money where xiangmu_id="&request("id")&" order by times asc")
while not rs3.eof
y=y+1
if int(request("px"))=y then
response.Write datevalue(rs3("times"))&"&nbsp;缴款："&rs3("money")&"元&nbsp;&nbsp;&nbsp;说明："&rs3("beizhu")&"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;客户签名："
end if
rs3.movenext
wend
rs3.close
