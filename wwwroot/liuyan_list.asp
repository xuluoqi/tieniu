...
.style6 {color: #0000FF}
--></style><link href="admin/zxcss.css" rel="stylesheet" type="text/css"><script language="javascript" src="inc/func.js" type="text/javascript"></script></head><body><%
set rs=server.createobject("adodb.recordset")
sql="select * from admin_liuyan where id="&request("id")&" "
rs.open sql,conn,1,1
%><table width="760"  border="0" align="center" bgcolor="#FFFFFF"><tr><td bgcolor="#FFFFFF"><%
if rs("topeple")=session("username") then
%><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC"><tr bgcolor="#99FFFF"><td width="409" height="18"><div align="left">&nbsp;&nbsp;&nbsp;<%= rs("title") %></div></td><td width="146"><%= rs("times") %></td><td width="104"> 留言者：<font color="#0000FF"><%= rs("frompeple") %></font><div align="center"></div></td><td width="46"><div align="center"><a href="javascript:openEditScript('liuyan_huifu.asp?id=<%= rs("id") %>',700,380)" >回复</a></div></td></tr><tr bgcolor="#FFFFFF"><td  colspan="4"><div align="right"></div><table width="726"  border="0" align="center"><tr><td width="720"><p><%= encode(rs("neirong")) %></p><%
if rs("pic")<>""then
%><img src="<%= rs("pic") %>">
                        <%
end if
%></td></tr></table></td></tr><%
if rs("huifu")<>"" then
%><tr bgcolor="#FFFFFF"><td height="29" colspan="4"><div align="right" class="style6"><div align="left"><table width="724" height="19" border="0" align="center" cellpadding="0" cellspacing="0"><tr><td><font color="#0000FF">我</font>的回复:<font color="#0000FF"><%= encode(rs("huifu")) %></font></td></tr></table></div></div></td></tr><%
end if
%></table><%
elseif rs("frompeple")=session("username") then
%><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC"><tr bgcolor="#99FFFF"><td width="414" height="18"><div align="left">&nbsp;&nbsp;&nbsp;<%= rs("title") %></div></td><td width="141"><%= rs("times") %></td><td width="150"> 我对<font color="blue"><%= rs("topeple") %></font>的留言
            <div align="center"></div></td></tr><tr bgcolor="#FFFFFF"><td height="24" colspan="3"><div align="right"></div><table width="701" border="0" align="center"><tr><td><p><%= encode(rs("neirong")) %></p><%
if rs("pic")<>""then
%><img src="<%= rs("pic") %>">
                        <%
end if
%></td></tr></table></td></tr><%
if rs("huifu")<>"" then
%><tr bgcolor="#FFFFFF"><td colspan="3"><div align="left"></div><div align="right" class="style6"><div align="left"><table width="728" border="0" align="center" cellpadding="0" cellspacing="0"><tr><td><font color=blue><%= rs("topeple") %></font>回复:<font color="#0000FF"><%= encode(rs("huifu")) %></font></td></tr></table></div></div></td></tr><%
end if
%></table><%
end if
%></td></tr></table><p align="center"><input type="submit" name="Submit" value="返回" onClick="javascript:history.go(-1)"></p></body></html>