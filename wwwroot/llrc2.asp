...
End If
End Sub
%><html><title>员工管理</title><link href="images/hs.css" rel="stylesheet" type="text/css"><meta http-equiv="Content-Type" content="text/html; charset=gb2312"><link href="admin/zxcss.css" rel="stylesheet" type="text/css"><style type="text/css"><!--
.style2 {color: #FF0000}
.style3 {
	color: #0000FF;
	font-size: 12px;
...
.style4 {color: #0033CC}
--></style><script language="javascript" src="inc/func.js" type="text/javascript"></script></head><body><p align="left"><%
if request("id")<>"" then
set rs2=server.CreateObject("adodb.recordset")
sql="select * from richeng where id="&request("id")&""
rs2.open sql,conn,1,1
%><span class="style3">　&nbsp;&nbsp;&nbsp;客户相关日程列表</span></p><table width="93%"  border="0" align="center" cellpadding="0" cellspacing="0" class="df"><tr><td><table width="750" height="123" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#A4B6D7" bgcolor="#A4B6D7" class="df"><tr bgcolor="#FF9966"><td height="20" colspan="2"><table width="100%"  border="0" cellspacing="0" cellpadding="0"><tr><td width="68%">&nbsp;&nbsp;客户:<%= conn.execute("select lxpeple from kehu where id="&rs2("kehu_id")&"")(0) %></td><td width="32%">手机号码：<%= GetTelNo(conn.execute("select telephone from kehu where id="&rs2("kehu_id")&"")(0)) %></td></tr></table></td><td height="20" colspan="2"><span class="style4"><a href="tjrc3.asp?id=<%= rs2("kehu_id") %>">添加日程</a></span></td></tr><tr bgcolor="#ECF5FF"><td height="26" colspan="4" bgcolor="#ECF5FF"><table width="114%" height="26" border="0" align="center" cellpadding="0" cellspacing="0"><tr><td height="26" valign="top">&nbsp;&nbsp;说明：<%= conn.execute("select shuoming from kehu where id="&rs2("kehu_id")&"")(0) %></td></tr></table></td></tr><tr bgcolor="#FFFFCC"><td width="477" height="20">&nbsp;&nbsp;<%= rs2("title") %></td><td width="104"><font color="blue"><%
if rs2("import")=1 then response.Write "重要"
%></font></td><td width="130"><div align="left"><%= rs2("times") %><%
if rs2("shijian")<>""then
select case rs2("shijian")
case 1
response.Write "[早上]"
case 2
response.Write "[中午]"
...
%>
                  　 
              </div></td><td width="39"><a href="huifu.asp?id=<%= rs2("id") %>">回复</a></td></tr><tr bgcolor="#ECF5FF"><td height="38" colspan="4" bgcolor="#ECF5FF"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0"><tr><td height="18" valign="top"><%= encode(rs2("shuoming")) %></td></tr><%
if rs2("huifu")<>"" then
%><tr><td height="20" valign="top" bgcolor="#ECF5FF"><font color="blue">回复：</font><%= encode(rs2("huifu")) %></td></tr><%
end if
%></table></td></tr></table><%
end if
%></td></tr><%
set rs=server.createobject("adodb.recordset")
sql="select * from richeng where kehu_id="&rs2("kehu_id")&" and id<>"&request("id")&" order by  times desc"
rs.open sql,connstr,1,1
%><tr><td ><%
DO While not rs.eof
%><table width="750"  border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#A4B6D7" bgcolor="#A4B6D7" class="df"><tr bgcolor="#ECF5FF"><td width="480" height="20" bgcolor="#FFFFCC">&nbsp;&nbsp;<%= rs("title") %></td><td width="102" bgcolor="#FFFFCC"><font color="#0000FF"><%
if rs("import")=1 then response.Write "重要"
%></font></td><td width="129" bgcolor="#FFFFCC"><div align="left"><%= rs("times") %><%
if rs("shijian")<>""then
...
%></div></td><td width="39" bgcolor="#FFFFCC"><a href="huifu.asp?id=<%= rs("id") %>">回复</a></td></tr><tr bgcolor="#ECF5FF"><td  colspan="4" valign="top" bgcolor="#ECF5FF"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="df"><tr><td  valign="top"><%= encode(rs("shuoming")) %></td></tr><%
if rs("huifu")<>"" then
%><tr><td height="20" valign="top" bgcolor="#ECF5FF"><font color="#0000FF">回复：</font><%= encode(rs("huifu")) %></td></tr><%
end if
%></table><%
rs.movenext
loop
...
rs2.close
set rs2=nothing
%><table width="100%"  border="0" cellspacing="0" cellpadding="0"><tr><td><div align="center"><a href="javascript:history.go(-1)">返回</a><input type="hidden" name="id" value="<%= request("id") %>">
    </div></td></tr></table><div align="center"><p>&nbsp;</p></div></body></html>