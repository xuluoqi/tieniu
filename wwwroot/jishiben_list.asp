...
--></style><script language="javascript" src="inc/func.js" type="text/javascript"></script><link href="admin/zxcss.css" rel="stylesheet" type="text/css"><link href="../admin/zxcss.css" rel="stylesheet" type="text/css"></head><body><p>&nbsp;</p><table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" class="df"><tr><td height="120"><%
if request("id")<>"" then
set rs2=server.createobject("adodb.recordset")
sql="select * from jishiben  where id="&request("id")&""
rs2.open sql,connstr,1,1
%><table width="699" height="126" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#A4B6D7" bgcolor="#A4B6D7"><tr bgcolor="#FFFFFF"><td height="25" bgcolor="#FFFFFF"><div align="center"><font color="#0000FF" ><%= rs2("title") %></font></div></td></tr><tr bgcolor="#FFFFFF"><td height="18" bgcolor="#FFFFFF"><div align="center"><%= rs2("times") %></div></td></tr><tr valign="top" bgcolor="#FFFFFF"><td height="83"><table width="100%" height="83" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999"><tr bgcolor="#FFFFFF"><td width="15%" height="40"><div align="right">工作内容：</div></td><td width="85%"><%= encode(rs2("neirong")) %></td></tr><tr bgcolor="#FFFFFF"><td height="39"><div align="right">公司配合说明：</div></td><td height="39"><%= encode(rs2("shuoming")) %></td></tr></table></td></tr></table></td></tr></table><table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0"><tr><td height="29"><div align="center"><a href="#" onClick="window.close()">关闭</a></div></td></tr></table><%
end if
rs2.close
set rs2=nothing
%></body></html>