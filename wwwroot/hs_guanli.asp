...
End If
End Sub
%><html><head><meta http-equiv="Content-Type" content="text/html; charset=gb2312"><title>无标题文档</title><link href="admin/zxcss.css" rel="stylesheet" type="text/css"></head><script src="Js/Calendar.js"></script><script language="javascript" src="inc/func.js" type="text/javascript"></script><link href="Css/calendar-blue.css" rel="stylesheet"><body><%
set rs2=server.CreateObject("adodb.recordset")
rs2.open "select * from hs_type",conn,1,1
%><table width="90%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#000000"><tr><form action="admin/chuzhu_jilu.asp" method="post" name="form1"><td width="40%" bgcolor="#FFFFFF">&nbsp;&nbsp;查询:
...
%>">
          ...
          <input type="submit" name="Submit2" value="查询"></td></form></tr></table><table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0"><tr><td><div align="center"></div><div align="center"><a href="admin/chuzhu_jilu.asp">出租记录浏览[点击]</a></div></td></tr></table><table width="90%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#000000"><%
while not rs2.eof
...
%><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"><tr><td height="18" width="33%"><table border="0" align="left" cellpadding="0" cellspacing="0" bgcolor="#ffffff"><%
do while not rs.eof
%><tr><%
for a=1 to 3
if not rs.eof then
i=i-1
%><td width="362" align=center valign="top"><div align="left">&nbsp;<a href="javascript:openwindow('admin/huensha_show.asp?id=<%= rs("id") %>',700,600)"><%= rs("num") %>/总库存</a><%= rs("sl") %>件/已出租
                      <%
out_num=rs("sl")-rs("sl2")
if isnull(out_num) then out_num=0
response.Write  out_num
%>
                  件/<a href="javascript:openwindow('admin/hs_out_in.asp?type=1&num=<%= rs("num") %>',700,300)">出租</a>/<a href="javascript:openwindow('admin/hs_out_in.asp?type=2&num=<%= rs("num") %>',700,300)">返租</a></div></td><%
rs.movenext
elseif rs.eof then
