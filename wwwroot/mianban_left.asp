...
End If
End Sub
%><HTML><HEAD><TITLE>中国联盟之家</TITLE><META http-equiv=Content-Type content="text/html; charset=gb2312"><SCRIPT>var badwords=''</SCRIPT><script language="javascript">
function aa(Dir)
...
</script><script language="javascript" src="../inc/func.js" type="text/javascript"></script><link href="admin/zxcss.css" rel="stylesheet" type="text/css"><style type="text/css"><!--
...
--></style><TBODY><TR><TD valign="top"><META content="MSHTML 6.00.3790.0" name=GENERATOR></HEAD><BODY background="img/bg.jpg" leftmargin="0" topmargin="0"><DIV align=left><form action="kehu_mianban.asp" method="post" name="form1" target="_top"><TABLE width=187 height="134" align=center cellPadding=0 cellSpacing=0><TBODY><TR><TD onMouseOver="aa('up')" onmouseout=StopScroll() align=middle></TD></TR><TR><TD height="62" ><img src="img/hs_01.gif" width="187" height="83"></TD></TR><TR><TD background="img/input.jpg"width="187" height="40" ><table width="100%"  border="0" cellspacing="0" cellpadding="0"><tr><td width="31%" height="38"><div align="right" class="style1">单号</div></td><td width="39%"><input name="id" type="text" id="id" size="8" value="<%= request("id") %>"></td><td width="40" height="36"><input name="image" type="image" src="img/button.jpg" width="20" height="36" ></td></tr></table></TD></TR><TR><TD height="2"></TD></TR></TBODY></TABLE><table width="187" height="276"  border="0" align="center" cellpadding="0" cellspacing="0"><tr><td height="276">&nbsp;</td><td width="178" valign="top"><table width="100%" height="84%"  border="0" cellpadding="0" cellspacing="0"><tr><td width="31%" height="276" valign="top"><table width="178" height="35"  border="0" align="center" cellpadding="0" cellspacing="0" background="img/hs_06_01.jpg" ><tr><td width="64">&nbsp;</td><td width="123"><span class="style17"><a href="admin/wancheng_print.asp?id=<%= request("id") %>" onClick="<%
if request("id")="" then response.write "return false;"
%>" target="main2">综合首页</a></span></td></tr></table><%
ver = conn.execute("select [version] from sysconfig")(0)
if ver<>"Customer" then
%><table width="178" height="32"  border="0" align="center" cellpadding="0" cellspacing="0" background="img/hs_06_02.jpg" style="display:none"><tr><td width="64">&nbsp;</td><td width="123"><span class="style17"><a href="fujia.asp?id=<%= request("id") %>" onClick="<%
if request("id")="" then response.write "return false;"
%>" target="main2"><span class="STYLE22">后期/购片</span></a></span></td></tr></table><table width="178"  border="0" align="center" cellpadding="0" cellspacing="0" background="img/hs_06_04.jpg"><tr><td width="60" height="32">&nbsp;</td><td width="118"><span class="style17"><a href="admin/lc_baobiao.asp?id=<%= request("id") %>" onClick="<%
if request("id")="" then response.write "return false;"
%>" target="main2"><span class="STYLE22">预约单/选片单</span></a></span></td></tr></table><%
end if
%><table width="178" height="32"  border="0" align="center" cellpadding="0" cellspacing="0" background="img/hs_06_05.jpg"><tr><td width="60" height="32">&nbsp;</td><td width="118"><a href="admin/sjxd.asp?id=<%= request("id") %>&action=edit" onClick="<%
if request("id")="" then response.write "return false;"
%>" target="main2" class="STYLE28"><span class="STYLE29">产品/时间调整</span></a></td></tr></table><table width="178" height="64"  border="0" align="center" cellpadding="0" cellspacing="0" background="img/hs_06_06.jpg"<%
if session("level")<>1 then response.write " style='display:none'"
%>>
            <tr><td height="32">&nbsp;</td><td><a href="admin/qujian_kj.asp?id=<%= request("id") %>" onClick="<%
if request("id")="" then response.write "return false;"
%>" target="main2">输出/验件/取件</a></td></tr><tr><td width="60" height="32">&nbsp;</td><td width="118"><a href="admin/hs_Arrangements.asp?id=<%= request("id") %>" onClick="<%
if request("id")="" then response.write "return false;"
%>" target="main2">礼服专区</a></td></tr></table><table width="178" height="32"  border="0" align="center" cellpadding="0" cellspacing="0" background="img/hs_06_07.jpg"<%
if session("level")<>1 then response.write " style='display:none'"
%>>
            <tr><td width="60" height="32">&nbsp;</td><td width="118"><a href="admin/ConsumptionSurvey.asp?id=<%= request("id") %>" onClick="<%
if request("id")="" then response.write "return false;"
%>" target="main2">客户消费调查</a></td></tr></table><table width="178" border="0" align="center" cellpadding="0" cellspacing="0" background="img/hs_06_08.jpg"><tr><td width="60" height="32">&nbsp;</td><td width="118"><span class="style17"><a href="admin/baobiaolist.asp?id=<%= request("id") %>&action=bb" onClick="<%
if request("id")="" then response.write "return false;"
%>" target="main2">留言交流</a></span></td></tr></table><table width="178" height="33"  border="0" align="center" cellpadding="0" cellspacing="0" background="img/hs_06_03.jpg"><tr><td width="60" height="33">&nbsp;</td><td width="118"><%
if request("id")<>"" then khid = conn.execute("select kehu_id from shejixiadan where id="&request("id"))(0)
response.write "<a href='admin/Vote.asp?Dh_Id="&request("id")&"&Kh_Id="&khid&"' target='main2'"
if request("id")="" then response.write " onClick='return false;'"
response.write ">100%调查表"&"</a>"
%></td></tr></table><%
if request("id")<>"" and CheckUserPermission("303") then
dim rs,str_telephone,telephone1,telephone2
set rs=server.CreateObject("adodb.recordset")
rs.open "select * from shejixiadan where id="&request("id"),conn,1,1
if not (rs.eof and rs.bof) then
telephone1 = conn.execute("select telephone from kehu where id="&rs("kehu_id"))(0)
str_telephone = telephone1
telephone2 = conn.execute("select telephone2 from kehu where id="&rs("kehu_id"))(0)
if trim(telephone2)<>"" then str_telephone = str_telephone & "," & telephone2
end if
rs.close
set rs = nothing
%><table width="178" height="32"  border="0" align="center" cellpadding="0" cellspacing="0" background="img/hs_06_02.jpg"><tr><td width="60" height="32">&nbsp;</td><td width="118"><a href="javascript:void(0);" onClick="javascript:document.getElementById('inp_smsphonenumber').value='<%= str_telephone %>';openSmsWindow('admin/sms_send.asp')">发送短信</a></td></tr></table><%
end if
%><table width="178" height="33"  border="0" align="center" cellpadding="0" cellspacing="0" background="img/hs_06_10.jpg"><tr><td width="60" height="33">&nbsp;</td><td width="118"><a href="#" onClick="window.top.close()">关闭窗口</a></td></tr></table></td></tr></table></td></tr></table><textarea name="inp_smsphonenumber" id="inp_smsphonenumber" style="display:none"></textarea></form></TR></TBODY></TABLE></DIV><DIV></DIV></BODY></HTML>