...
function check()
{
if(!CheckIsNull(document.Form1.shejishizhu,"请选择摄影助理！")) return false;
}
</script>
</head>
...
sql="insert into sell_jilu (yuangong_id,xiangmu_id,[name],dj,sl,beizhu,times)  values ("&Request("shejishizhu")&","&request("id")&",'"&conn.execute("select [name] from sell_type where  id="&request("name")&"")(0)&"',"&request("dj")&","&request("sl")&",'"&htmlencode2(request("beizhu"))&"',now())"
...
<input type="submit" name="Submit" value="添加">
    ...
    <td width="50" bgcolor="#FFFFFF"><div align="center"><a href="fujia.asp?id=<%=request("id2")%>" onClick="history.go(-1)">返回</a></div></td>
  </tr>
  </form>
</table>
<%set rs=server.CreateObject("adodb.recordset")
...
<form action="sell.asp?action=edited" method="post" name="Form1">
    <tr bgcolor="#FFFFFF">
      <td height="22" colspan="3"><div align="center">类别列表</div></td>
    </tr>
    <tr bgcolor="#FFFFFF">
      <td width="226" height="18"><div align="center"></div>        
        <div align="center">类别</div></td>
      <td width="148"><div align="center">单价</div></td>
      <td width="148"><div align="center">管理</div></td>
    </tr>
	<%while not rs.eof%>
    <tr bgcolor="#FFFFFF">
      ...
      元</div></td>
      <td><div align="center"><a href="sell.asp?id=<%=rs("id")%>&id2=<%=request("id2")%>&action=dele" onClick="return confirm('确定要删除吗？')">删除</a></div></td>
    </tr>
	<%rs.movenext
	wend 
	rs.close
...
<form action="sells.asp?action=added2" method="post" name="Form1" onSubmit="return check()">
  <tr>
    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <div align="center">
          <select name="shejishizhu" id="shejishizhu">
            <option value="" selected>请选择摄影助理</option>
            <% 
	  Set S_Rs=Conn.Execute("Select distinct userid From xiadan Where type=12 and xiangmu_id="&Request("id"))
...
<table width="81%"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="17%" valign="top"><div align="right">常用语：</div></td>
    <td width="83%">
      <div align="left">
...
<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#efefef">
  <tr bgcolor="#FFFFFF">
    ...
    <td width="14%" bgcolor="#efefef"><a href="sell.asp?action=add">添加记录</a></td>
  </tr>
</table>
<%set rs=server.CreateObject("adodb.recordset")
...
<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td><div align="center">目前还没有数据</div></td>
  </tr>
</table>
<%else%>
...
<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td><div align="center">共有记录&nbsp;<font color="#FF0000"><%= rs.recordcount %></font>&nbsp;个　当前页<span class="style3"> <%= page %>/<%= pgnm %></span>：
        <% If page>1 Then %>
