...
End If
End Sub
%><html><head><meta http-equiv="Content-Type" content="text/html; charset=gb2312"><title>无标题文档</title><script language="javascript">
function check()
{
...
rs("huifu")=htmlencode2(request("huifu"))
rs.update
%><script language="javascript">
alert("回复留言成功！");window.close()
</script><%
end if
%><p>&nbsp;</p><table width="480" height="319" border="0" align="center" cellpadding="0" cellspacing="0"><form action="liuyan_huifu.asp" method="post" name="form1" onSubmit="return check()"><tr><td width="480" height="30">&nbsp;</td></tr><tr><td height="21"><div align="center" class="style1">留言回复</div></td></tr><tr><td height="120"><div align="center"><textarea name="huifu" cols="70" rows="8" id="huifu"><%= rs("huifu") %></textarea></div></td></tr><tr><td height="79"><div align="center"><input name="tijiao" type="submit" id="tijiao" value="提交">　　　　      
            
        <input type="button" name="Submit" value="关闭" onClick="javascript:window.close()"><input name="id" type="hidden" value="<%= request("id") %>">
	  </div></td></tr></form></table><blockquote><p><%
rs.close
set rs=nothing
