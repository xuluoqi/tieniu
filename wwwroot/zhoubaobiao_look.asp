...
--></style></head><body><p><%
set rs=server.createobject("adodb.recordset")
sql="select * from zhoubaobiao where yuangong='"&session("username")&"' order by times desc "
rs.open sql,conn,1,1
...
%></p><table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0"><tr><td><div align="center"><a href="zhoubaobiao.asp">添加周报表 </a></div></td></tr><tr><td><div align="center"></div></td></tr><tr><td height="22"><table width="100%" height="18" border="0" align="center" cellpadding="０" cellspacing="1" bgcolor="#666666"><%
DO While not rs.eof
%><tr bgcolor="#FFFFFF" onMouseOver="this.bgColor='#efefef'" onMouseOut="this.bgColor='#ffffff'"><td width="412" >&nbsp;&nbsp;<a href="javascript:openEditScript('zhoubaobiao_list.asp?action=list&id=<%= rs("id") %>',730,350)"><%= rs("title") %></a></td><td width="201">&nbsp;&nbsp;<%= rs("times") %><div align="center"></div></td><td width="85" ><%
if rs("times")>=date then
%><a href="javascript:openEditScript('zhoubaobiao_list.asp?action=xiugai&id=<%= rs("id") %>',750,610)">修改</a><%
end if
%></td></tr><%
rs.movenext
i=i+1
...
loop
%></table><div align="center"></div></td></tr><tr><td height="47"><div align="center">共有记录&nbsp;<span class="style3"><%=  rs.recordcount %>&nbsp;</span>个,当前页<span class="style3"><%=  page %>/<%=  pgnm %></span>：
        <%
If page>1 Then
%><a href="zhoubaobiao_look.asp?page=<%=  page-1 %>">上一页</a><%
Else
%><%=  "上一页" %><%
End If
If page<>pgnm Then
%><a href="zhoubaobiao_look.asp?page=<%= page+1 %>"> 下一页</a><%
Else
%><%=  "下一页" %><%
End If
%></div></td></tr></table><blockquote>&nbsp;	</blockquote><%
rs.close
set rs=nothing
%></body></html>