...
rs("times")=now()
rs.update
response.Write"<script>alert('添加周报表成功！');location='zhoubaobiao_look.asp'</script>"
rs.close
set rs=nothing
end if
%></p><table width="80%" height="147"  border="0" align="center" cellpadding="0" cellspacing="0"><form action=""  method="post" name="form1" onSubmit="return check()"><tr><td width="63%" height="89"><table width="58%"  border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#D4D0C8"><tr><td height="38" colspan="2"><div align="left"><span class="style4">　　　　　　　　　　　　　　添加周报表</span></div></td></tr><tr><td height="37" colspan="2"><input name="title" type="text" id="title" size="50" value="<%
response.Write left(date,4)&"年　月份第　周报表"
%>">
            <span class="style5">(请填写月份和第几周)</span></td></tr><tr><td width="63%" height="18" bgcolor="#FFFFFF"><span class="style5">本周主要客户群</span></td></tr><tr><td height="67"><textarea name="kehu" cols="74" rows="6" id="kehu"></textarea></td></tr><tr><td height="18">&nbsp;</td></tr><tr><td height="18" bgcolor="#FFFFFF"><span class="style5">本周心得(不少50字)
          </span></td></tr><tr><td height="141"><span class="style5"><textarea name="xinde" cols="74" rows="9" id="xinde"></textarea></span></td></tr><tr><td height="18" bgcolor="#FFFFFF"><span class="style5">下周业绩定位(不少于50字)</span></td></tr><tr><td height="24"><textarea name="fangxiang" cols="74" rows="9" id="fangxiang"></textarea></td></tr></table></td><td width="37%" rowspan="2"><table width="288" height="475" border="0" cellpadding="0" cellspacing="0"><tr><td height="49">近一周客户列表:</td></tr><tr><td height="426" valign="top"><textarea name="company" cols="50" rows="29" id="company"><%
set rs=server.CreateObject("adodb.recordset")
rs.open "select * from kehu where userid='"&session("userid")&"' and times>=#"&date-7&"# order by times",conn,1,1
while not rs.eof
...
%></textarea></td></tr></table></td></tr><tr><td height="58"><div align="center"><input name="tijiao" type="submit" id="tijiao" value="提交">
      　　　　　
      <input name="quexiao" type="button" id="quexiao" value="返回" onClick="javascript:history.go(-1)"></div></td></tr></form></table></body></html>