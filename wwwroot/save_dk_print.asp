...
End If
End Sub
%><html><head><meta http-equiv="Content-Type" content="text/html; charset=gb2312"><title>抵口凭证打印</title><link href="admin/zxcss.css" rel="stylesheet" type="text/css"><script language="javascript" src="inc/func.js" type="text/javascript"></script></head><body><%
set rs=server.CreateObject("adodb.recordset")
rs.open "select * from save_dk where id="&request("id")&"" ,conn,1,1
set rs3=server.CreateObject("adodb.recordset")
rs3.open "select * from shejixiadan where id="&rs("xiangmu_id")&"",conn,1,1
%><table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0"><tr><td> &nbsp;&nbsp;单号：<%= rs("xiangmu_id") %><%
if rs3("danhao")<>"" or not isnull(rs3("danhao")) then response.write "&nbsp;/&nbsp;"&rs3("danhao") end if
%>
    &nbsp;&nbsp;&nbsp;客人：<%
response.write conn.execute("select lxpeple from kehu where id="&rs3("kehu_id"))(0)
%>&nbsp;&nbsp;&nbsp;&nbsp;门市：<%= conn.execute("select peplename from yuangong where username='"&rs("userid")&"'")(0) %>&nbsp;&nbsp;<%= datevalue(rs("times")) %>&nbsp;&nbsp;<%= getPrintString(rs3("kehu_id")) %></td></tr></table><table width="98%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC"><tr bgcolor="#efefef"><td height="32" bgcolor="#FFFFFF">&nbsp;&nbsp;
      抵扣凭证金额<%= rs("money") %>&nbsp;元&nbsp;&nbsp;
	<%
...
%><div align="center"></div></td></tr><tr bgcolor="#FFFFFF"><td height="80" valign="top"><div align="left">&nbsp;&nbsp;<br>
&nbsp;&nbsp;      缴款说明：<%= encode(rs("beizhu")) %><br>
&nbsp;&nbsp;&nbsp;打单:<%= session("username") %><br>
    &nbsp;&nbsp;&nbsp;客人签名： &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;公司经手人签名:</div></td></tr></table><%
rs3.close
Set rs3=nothing
rs.close
set rs=nothing
