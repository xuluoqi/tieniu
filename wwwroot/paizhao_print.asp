...
End If
End Sub
%><html><head><meta http-equiv="Content-Type" content="text/html; charset=gb2312"><title>定金收款打印</title><link href="admin/zxcss.css" rel="stylesheet" type="text/css"><script language="javascript" src="inc/func.js" type="text/javascript"></script></head><body><%
set rs=server.CreateObject("adodb.recordset")
...
%><table width="88%"  border="0" cellpadding="0" cellspacing="1" style="margin-left:10px"><tr><td> &nbsp;&nbsp;单号：<%= rs("xiangmu_id") %><%
if rs3("danhao")<>"" and not isnull(rs3("danhao")) then response.write "&nbsp;/&nbsp;"&rs3("danhao") end if
%>
      &nbsp;&nbsp;<%= datevalue(rs("times")) %>&nbsp;&nbsp;&nbsp;
      <%
...
%>&nbsp;&nbsp;&nbsp;<%= getPrintString(rs3("kehu_id")) %></td></tr></table>


<table width="88%"  border="1" bordercolor="#dedede" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC" style="margin-left:10px;border-collapse:collapse "><tr bgcolor="#efefef"><td height="33" bgcolor="#FFFFFF"><div align="left">&nbsp; <%= conn.execute("select jixiang from jixiang where id="&conn.execute("select jixiang from shejixiadan where id="&request("xiangmu_id")&"")(0)&"")(0) %>&nbsp;[<%= conn.execute("select jixiang_money from shejixiadan where id="&request("xiangmu_id")&"")(0) %>元]&nbsp;&nbsp;&nbsp;拍照金：<%= rs("money") %>&nbsp;元&nbsp;
	<%
...
%></div><div align="center"></div><div align="center"></div></td></tr><tr bgcolor="#FFFFFF"><td height="80" valign="top"><div align="left"><table width="96%"  border="0" align="center" cellpadding="0" cellspacing="0"><tr><td><%
if rs("type")=1 then
...
if instr(cstr(Arr_PrintSetting(3)),"1")>0 then
%>
◇服务内容◇
...
if instr(cstr(Arr_PrintSetting(3)),"0")>0 then
%>
◇取件内容◇
<div style="width:90%; padding:3px"><table width="100%"  border="0" cellspacing="0" cellpadding="0"><tr><%
count11=ubound(id)+1
...
%><br>
        &nbsp;公司经手人签名:                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 打单:<%= session("username") %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; 客户签名： &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td></tr></table></div></td></tr>
        <tr bgcolor="#efefef">
<td height="33" bgcolor="#FFFFFF">&nbsp;<STRONG>顾客须知:</STRONG>① 拍照时如对彩妆、造型、摄影方式有意见，请当面与服务人员沟通。②拍摄服务完成后，请与接待门市人员确定选片日期。③为加强公司服务品质，请在确定选片日期当天下班2个小时之前来选片。</td>
</tr>
        </table>
