...
End If
End Sub
%><html><head><meta http-equiv="Content-Type" content="text/html; charset=gb2312"><title>无标题文档</title><link href="admin/zxcss.css" rel="stylesheet" type="text/css"><script language="javascript" src="inc/func.js" type="text/javascript"></script></head><body><br><%
if request("action")="add" then
userid=conn.execute("select userid from shejixiadan where id="&request("id")&"")(0)
conn.execute("insert into qujian (userid,beizhu,times,xiangmu_id) values ('"&userid&"','"&htmlencode2(request("beizhu"))&"',#"&now&"#,"&request("id")&")")
end if
set rs=server.CreateObject("adodb.recordset")
rs.open "select * from qujian where xiangmu_id="&request("id")&"",conn,1,1
%><table width="80%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC"><%
while not rs.eof
%><tr bgcolor="#FFFFFF"><td><div align="right"></div><div align="right">取件时间：</div></td><td width="68%">&nbsp;<%= rs("times") %></td><!--
    <td width="16%"><div align="center"><a href="admin/qujian_print.asp?id=<%= rs("id") %>">取件打印</a></div></td>
	-->
  </tr><tr bgcolor="#FFFFFF"><td width="16%" valign="top"><div align="right">备注说明：</div></td><td colspan="2"> &nbsp;<%= encode(rs("beizhu")) %></td></tr><%
rs.movenext
wend
rs.close
set rs=nothing
%></table><br><br><!--
<form action="qujian.asp?action=add" method="post" name="form1"><table width="80%"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC"><tr bgcolor="#FFFFFF"><td valign="top"><div align="center">取件备注</div></td></tr><tr bgcolor="#FFFFFF"><td valign="top"><div align="right"></div><div align="center"><textarea name="beizhu" cols="65" rows="8" id="beizhu"></textarea></div></td></tr></table><table width="80%"  border="0" align="center" cellpadding="0" cellspacing="0"><tr><td height="40"><div align="center"><input type="submit" name="Submit" value="提交">
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <input type="reset" name="Submit" value="重置"><input name="id" type="hidden" id="id" value="<%= request("id") %>">
