...
session.Timeout=60
%><html><head><meta http-equiv="Content-Type" content="text/html; charset=gb2312"><title>无标题文档</title><link href="admin/zxcss.css" rel="stylesheet" type="text/css"></head><script language="javascript" src="inc/func.js" type="text/javascript"></script><%
...
%><body><%
set rs=server.CreateObject("adodb.recordset")
rs.open "select * from  save_money where datevalue(times)=#"&request("times")&"#  and userid='"&session("userid")&"' order by times ",conn,1,1
%><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC"><%
while not rs.eof
%><tr bgcolor="#efefef"><td width="16%" height="19"><div align="left">&nbsp;&nbsp;&nbsp;顾客:<%= conn.execute("select lxpeple from kehu where id="&conn.execute("select kehu_id from shejixiadan where id="&rs("xiangmu_id")&"")(0)&"")(0) %></div></td><td width="27%"><div align="left">&nbsp;&nbsp;&nbsp;套系:<%= conn.execute("select jixiang from jixiang where id="&conn.execute("select jixiang from shejixiadan where id="&rs("xiangmu_id")&"")(0)&"")(0) %></div></td><td width="18%"><div align="left">&nbsp;&nbsp;金额:<font color="#FF0000"><%= rs("money") %></font>(元)</div></td><td><div align="center"><div align="center"></div><div align="left"></div></div><div align="left">&nbsp;&nbsp;<%= rs("times") %></div></td></tr><tr bgcolor="#FFFFFF"><td height="19" colspan="4">&nbsp;&nbsp;&nbsp;收款说明：<%= encode(rs("beizhu")) %></td></tr><%
rs.movenext
wend
rs.close
set rs=nothing
%></table><table width="100%"  border="0" cellspacing="0" cellpadding="0"><tr><td height="36"><div align="center"><a href="#" onClick="javascript:window.close()">关闭</a></div></td></tr></table></body></html>