...
.style4 {color: #D4D0C8}
.style5 {color: #000000}
--></style><script language="javascript" src="inc/func.js" type="text/javascript"></script></head><body><%
set rs=server.CreateObject("adodb.recordset")
if request("action")="ky" then
rs.open "select * from shejixiadan where ky_name='"&session("username")&"'",conn,1,1
elseif request("action")="yj" then
rs.open "select * from shejixiadan where wc_name='"&session("username")&"'",conn,1,1
end if
...
%><table width="100%"  border="0" cellpadding="0" cellspacing="0" bgcolor="#efefef"><tr><td><div align="center"><strong><%
...
%></strong></div></td></tr></table><table width="100%"   border="0" align="center" cellpadding="0" cellspacing="0" class="df"><tr><td><table width="100%"  border="0" align="left" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC"><tr bgcolor="#CCFFFF"><td height="22"><div align="center">单号</div></td><td><div align="center">套系</div></td><td width="100"><div align="center">客人</div></td><td width="70" bgcolor="#CCFFFF"><div align="center"></div><div align="center">取件时间</div></td><td width="97" bgcolor="#CCFFFF"><div align="center"><%
select case  request("action")
case "ky"
response.Write "调色人员"
case "yj"
...
%></div></td><td width="168"><div align="center"></div><div align="center">文件保存路径</div></td><td width="162"><div align="center"></div><div align="center"><%
select case  request("action")
case "ky"
response.Write "确认时间"
case "yj"
...
%></div></td></tr><%
DO While not rs.eof
%><tr bgcolor="#FFFFFF"><td width="42" height="22"><div align="center"><%= rs("id") %></div></td><td width="134" height="22" bgcolor="#FFFFFF"><div align="center"><%
response.Write conn.execute("select jixiang from jixiang where id="&rs("jixiang")&"")(0)
%></div></td><td><div align="center"><%= conn.execute("select lxpeple from kehu where  id="&rs("kehu_id")&"")(0) %></div></td><td bgcolor="#FFFFFF"><div align="center"><%= conn.execute("select qj_time from shejixiadan where id="&rs("id")&"")(0) %></div></td><td bgcolor="#FFFFFF"><div align="center"><%
select case  request("action")
case "ky"
response.Write rs("xp_name")
case "yj"
response.Write rs("sj_name")
end select
%></div></td><td bgcolor="#FFFFFF"><div align="center"></div><div align="center"></div><div align="center"><%
...
%></div></td><td bgcolor="#FFFFFF"><div align="center"></div><div align="center">		  &nbsp;
              <%
select case  request("action")
case "ky"
response.Write rs("lc_ky")
case "yj"
response.Write rs("lc_wc")
end select
%>
          &nbsp;</div></td></tr><%
rs.movenext
...
loop
%></table></td></tr><tr><td height="22" bgcolor="#FFFFFF"><div align="center">共有记录&nbsp;<font color="#FF0000"><%=  rs.recordcount %></font>&nbsp;个　当前页<span class="style3"><%=  page %>/<%=  pgnm %></span>：
        <%
If page>1 Then
%><a href="kj_yj.asp?page=<%=  page-1 %>&action=<%= request("action") %>">上一页</a><%
Else
%><%=  "上一页" %><%
End If
If page<>pgnm Then
%><a href="kj_yj.asp?page=<%= page+1 %>&action=<%= request("action") %>"> 下一页</a><%
Else
%><%=  "下一页" %><%
End If
%></div></td></tr></table><%
