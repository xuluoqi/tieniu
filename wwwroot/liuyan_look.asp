...
%><html><head><meta http-equiv="Content-Type" content="text/html; charset=gb2312"><title>无标题文档</title><link href="zxcss.css" rel="stylesheet" type="text/css"><link href="admin/zxcss.css" rel="stylesheet" type="text/css"><script language="javascript" src="inc/func.js" type="text/javascript"></script></head><body><p>&nbsp;</p><p><%
set rs=server.createobject("adodb.recordset")
sql="select * from admin_liuyan where frompeple='"&session("username")&"'or topeple='"&session("username")&"'order by times desc "
rs.open sql,conn,1,1
...
%></p><table width="79%" height="93"  border="0" align="center" cellpadding="0" cellspacing="0"><tr><td height="20"><div align="center"><a href="news_ADD.asp">留言添加</a></div></td></tr><tr><td height="73" ><div align="center"><table width="652" height="56" border="0" align="center" bgcolor="#FFFFFF"><tr><td ><table width="100%" height="18" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC"><%
DO While not rs.eof
if rs("topeple")=session("username") then
%><tr bgcolor="#FFCCFF" onMouseOver="this.bgColor='#FF99FF'" onMouseOut="this.bgColor='#FFCCFF'"><td height="18" bgcolor="#FFFFFF"><div align="left">&nbsp;&nbsp;<a href="liuyan_list.asp?id=<%= rs("id") %>"><%= rs("title") %></a></div></td><td width="177" bgcolor="#FFFFFF"><%= rs("times") %></td><td width="142" bgcolor="#FFFFFF"> &nbsp;留言者：<font color="#0000FF"><%= rs("frompeple") %></font><div align="center"></div></td></tr><%
elseif rs("frompeple")=session("username") then
%><tr bgcolor="#FFCCFF" onMouseOver="this.bgColor='#FF99FF'" onMouseOut="this.bgColor='#FFCCFF'"><td width="323" height="18" bgcolor="#FFFFFF"><div align="left">&nbsp;&nbsp;<a href="liuyan_list.asp?id=<%= rs("id") %>"><%= rs("title") %></a></div></td><td width="177" bgcolor="#FFFFFF"><%= rs("times") %></td><td width="142" bgcolor="#FFFFFF"> &nbsp;我对<font color="#0000FF"><%= rs("topeple") %></font>的留言
...
loop
%></table></td></tr><tr><td><div align="center">共有记录&nbsp;<span class="style3"><%=  rs.recordcount %>&nbsp;</span>个,当前页<span class="style3"><%=  page %>/<%=  pgnm %></span>：
                <%
If page>1 Then
%><a href="liuyan_look.asp?page=<%=  page-1 %>">上一页</a><%
Else
%><%=  "上一页" %><%
End If
If page<>pgnm Then
%><a href="liuyan_look.asp?page=<%= page+1 %>"> 下一页</a><%
Else
%><%=  "下一页" %><%
End If
%></div></td></tr></table></div></td></tr></table><blockquote><div align="center"></div></blockquote><%
rs.close
set rs=nothing
%></body></html>