...
End If
End Sub
%><html><head><meta http-equiv="Content-Type" content="text/html; charset=gb2312"><title>无标题文档</title><link href="zxcss.css" rel="stylesheet" type="text/css"><style type="text/css"><!--
.style3 {color: #FF0000}
.style4 {color: #0066FF}
--></style><script language="javascript" src="inc/func.js" type="text/javascript"></script><link href="admin/zxcss.css" rel="stylesheet" type="text/css"></head><script language="javascript">
function check()
{if(!CheckIsNumericOrNull(document.form1.feiyong,"请填写设计费用！","费用应为数字！")) return false;
if(!CheckIsNull(document.form1.timelimit,"请填写限期时间！")) return false;
if(!CheckIsNull(document.form1.shuoming,"请填写下单具体说明！"))return false;
if (!CheckIsNumericOrNull(document.form1.yewuchoucheng,"请填写业务抽成！","业务抽成应为数字！")) return false;
if(!CheckIsNumericOrNull(document.form1.dingjin,"请填写定金！","定金填写错误！"))return false;
}
</script>　
<body><%
select case request("action")
case "dele"
conn.execute("delete*from shenhe where id="&request("id")&"")
response.Redirect "shenqing.asp"
case else
set rs=server.CreateObject("adodb.recordset")
rs.open "select * from shenhe where yewuyuan='"&session("username")&"' order by times desc",conn,1,1
%><table width="766" border="0" align="center" cellpadding="0" cellspacing="0"><tr><td width="735"><div align="center" class="style4"><div align="center">设计项目申请</div></div></td></tr></table><table width="100%" height="50" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC"><tr bgcolor="#FFCCCC"><td width="265" height="21"><div align="center">公司名称</div></td><td width="202" bgcolor="#FFCCCC"><div align="center">项目</div></td><td width="82"><div align="center">申请时间</div></td><td width="44"><div align="center">&nbsp;</div></td></tr><%
while not rs.eof
%><tr bgcolor="#FFFFCC"><td height="29">&nbsp;&nbsp;<%= rs("companyname") %></td><td bgcolor="#FFFFCC">&nbsp;<%= rs("jixiang") %></td><td bgcolor="#FFFFCC"><div align="center"><%= rs("yewuyuan") %></div></td><td><div align="center">	&nbsp;<a href="shenqing.asp?action=dele&id=<%= rs("id") %>" onClick="return confirm('确定要删除吗?')">删除</a></div></td></tr><%
rs.movenext
wend
rs.close
set rs=nothing
