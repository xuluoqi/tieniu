...
.style4 {color: #6600FF}
.style9 {color: #FFFFFF}
--></style><link href="admin/zxcss.css" rel="stylesheet" type="text/css"><script language="javascript" src="inc/func.js" type="text/javascript"></script><style type="text/css"><!--
.STYLE10 {color: #999999}
.STYLE11 {color: #666666}
.style41 {color: #0000FF}
--></style></head><body><%
set rs=server.CreateObject("adodb.recordset")
rs.open "select * from shejixiadan where kj_time<=#"&date+2&"#  and isnull(lc_ky) and (wc_name='' or isnull(wc_name)) and isnull(lc_wc) order by kj_time desc",conn,1,1
%><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"><tr><td><div align="center" class="style2"><table width="100%" border="0" cellpadding="0" cellspacing="0" background="img/33.JPG"><tr><td width="92%"><div align="center" class="style2"><div align="left">&nbsp;<span class="style4">&nbsp;最近<span class="style9">选片安排</span>&nbsp;提前三天提醒，请点击单号进入面板</span></div></div></td><td width="8%"><a href="kanjian.asp?action=wc" target="main2"><font color="#0000FF">更多．．</font></a></td></tr></table></div></td></tr><tr><td height="23"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC"><%
if  rs.eof then
%><tr bgcolor="#FFFFFF"><td height="13" colspan="7"><div align="center"><span class="style1">今日无选片记录</span></div></td></tr><%
else
%><tr bgcolor="#99FFFF"><td height="13"><div align="center"><span class="STYLE10">单号/手动单号</span></div></td><td align="center">姓名</td><td align="center">联系电话</td><td align="center">摄影师</td><td align="center">门市</td><td align="center">确认流程</td><td align="center">选片日期</td></tr><%
while not rs.eof
%><tr bgcolor="#FFFFFF"  onMouseOver="this.bgColor='#FF9966'" onMouseOut="this.bgColor='#FFFFFF'"><td height="18" align="center"><a href="javascript:openEditScript('kehu_mianban.asp?id=<%= rs("id") %>',450,500)">
            <%
...
%></a></td><td height="18" align="center"><a href="javascript:openEditScript('ckkh.asp?id=<%= rs("kehu_id") %>',800,350)">
            <%
...
rs4.close()
set rs4=nothing
%></a><a href="javascript:openEditScript('ckkh.asp?id=<%= rs("kehu_id") %>',800,350)"></a></td><td align="center">&nbsp;<%= GetTelNo(conn.execute("select telephone from kehu where id="&rs("kehu_id")&"")(0)) %></td><td align="center"><%
...
rs5.close
set rs5=nothing
%></td><td align="center" ><%= conn.execute("select peplename from yuangong where username='"&rs("userid")&"'")(0) %></td><td align="center"><div align="center"><%
if isnull(rs("lc_cp")) then
response.write "催"&getPerStep(rs("id"))&"确认"
else
%><a href="javascript:openwindow('xiadan2.asp?id=<%= rs("id") %>&action=edit&action2=fenpei',900,600)">分配员工</a><%
end if
%></div></td><td align="center"> &nbsp;
            <%
response.Write rs("kj_time")
response.Write rs("kj")
%></td></tr><%
rs.movenext
wend
end if
...
set rs=nothing
set rs=server.CreateObject("adodb.recordset")
rs.open "select * from shejixiadan where xg_time<=#"&date+2&"#  and isnull(xg_sj) and (wc_name='' or isnull(wc_name)) and isnull(lc_wc) order by xg_time desc",conn,1,1
%><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"><tr><td><div align="center" class="style2"><table width="100%" border="0" cellpadding="0" cellspacing="0" background="img/33.JPG"><tr><td width="92%"><div align="center" class="style2"><div align="left">&nbsp;<span class="style4">&nbsp;最近<span class="style9">看版安排</span>&nbsp;提前三天提醒，请点击单号进入面板</span></div></div></td><td width="8%"><a href="kanjian.asp?action=wc" target="main2"><font color="#0000FF">更多．．</font></a></td></tr></table></div></td></tr><tr><td height="23"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC"><%
if rs.eof or StepControl=1 then
%><tr bgcolor="#FFFFFF"><td height="13" colspan="7"><div align="center"><span class="style1">当前无看版记录</span></div></td></tr><%
else
%><tr bgcolor="#99FFFF"><td height="13"><div align="center" class="STYLE10">单号/手动单号</div></td><td><div align="center" class="STYLE10">姓名</div></td><td><div align="center" class="STYLE10">联系电话</div></td><td><div align="center" class="STYLE10">设计师</div></td><td width="10%" align="center"><div align="center" class="STYLE17">看版</div></td><td><div align="center" class="STYLE10">确认流程</div></td><td><div align="center" class="STYLE10">看版日期</div></td></tr><%
while not rs.eof
...
%><a href="javascript:openwindow('admin/fenpei.asp?action=xg&id=<%= rs("id") %>&level=1',800,600)">分配员工</a><%
end if
%></div></td><td>&nbsp; &nbsp;
            <%
...
set rs=nothing
set rs=server.CreateObject("adodb.recordset")
rs.open "select * from shejixiadan where not isnull(lc_sc) and isnull(zd_name) and (wc_name='' or isnull(wc_name)) and isnull(lc_wc) and shejiwancheng=0 order by qj_time",conn,1,1
%><table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC"><tr><td colspan="6" background="img/33.JPG">&nbsp;&nbsp;&nbsp;<span class="style41">未成品验件项目&nbsp;</span><span class="style9">未认领&nbsp;</span><span class="style41">&nbsp;</span>点击客人或单号显示联系人信息</td></tr><%
if rs.eof or StepControl=1 then
%><tr bgcolor="#FFFFFF"><td colspan="6"><div align="center"><span class="style1">暂时还没有要成品验件项目</span></div></td></tr><%
else
%><tr bgcolor="#99FFFF"><td><div align="center" class="STYLE11">系统/手动单号</div></td><td><div align="center" class="STYLE11">客户名</div></td><td><div align="center" class="STYLE11">取件日期</div></td><td><div align="center" class="STYLE11">输出员工</div></td><td colspan="2"><div align="center" class="STYLE11">电子签名流程</div></td></tr><%
while not rs.eof
...
%></a></div></td><td><div align="center"><a href="javascript:openEditScript('kehu_mianban.asp?id=<%= rs("id") %>',450,500)">
      <%
set rs4=server.CreateObject("adodb.recordset")
rs4.open "select * from kehu where id="&rs("kehu_id")&"",conn,1,1
response.write rs4("lxpeple")
...
%></td><td><div align="center"><%= rs("sc_name") %></div></td><td colspan="2"><div align="center"><%
if isnull(rs("lc_zd")) and not isnull(rs("lc_sc")) then
%><a href="javascript:openwindow('admin/fenpei.asp?action=zd&id=<%= rs("id") %>&level=1',800,600)">分配员工</a><%
else
response.write "催"&getPerStep(rs("id"))&"确认"
end if
%></div></td></tr><%
...
%></table><%
set rs=server.CreateObject("adodb.recordset")
rs.open "select * from shejixiadan where qj_time<=#"&date+2&"# and (wc_name='' or isnull(wc_name)) and isnull(lc_wc) order by qj_time desc",conn,1,1
%><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"><tr><td><div align="center" class="style2"><table width="100%" border="0" cellpadding="0" cellspacing="0" background="img/33.JPG"><tr><td width="92%"><div align="center" class="style2"><div align="left">&nbsp;<span class="style4">&nbsp;最近<span class="style9">门市取件客户</span>&nbsp;提前三天提醒，请点击单号进入面板</span></div></div></td><td width="8%"><a href="qujian2.asp?action=wc" target="main2"><font color="#0000FF">更多．．</font></a></td></tr></table></div></td></tr><tr><td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC"><%
if  rs.eof then
%><tr bgcolor="#FFFFFF"><td height="18" colspan="6"><div align="center"><span class="style1">今日无取件记录</span></div></td></tr><%
else
%><tr bgcolor="#99FFFF"><td height="18"><div align="center"><span class="STYLE10">单号/手动单号</span></div></td><td height="18"><div align="center">姓名</div></td><td><div align="center">联系电话</div></td><td><div align="center">门市</div></td><td><div align="center">确认流程</div></td><td><div align="center">取件日期</div></td></tr><%
while not rs.eof
%><tr bgcolor="#FFFFFF"  onMouseOver="this.bgColor='#FF9966'" onMouseOut="this.bgColor='#FFFFFF'"><td height="18"><div align="center"><a href="javascript:openEditScript('kehu_mianban.asp?id=<%= rs("id") %>',450,500)">
                <%
response.Write rs("id")
...
rs4.close()
set rs4=nothing
%></a></div></td><td>&nbsp;&nbsp;<%= GetTelNo(conn.execute("select telephone from kehu where id="&rs("kehu_id")&"")(0)) %></td><td><div align="center"><%= conn.execute("select peplename from yuangong where username='"&rs("userid")&"'")(0) %></div></td><td><div align="center"><a href="javascript:openwindow('admin/fenpei.asp?action=wc&id=<%= rs("id") %>&level=1',800,600)">分配员工</a></div></td><td> &nbsp;
              <%
...
%></table></td></tr></table><%
set rs=server.CreateObject("adodb.recordset")
rs.open "select * from shejixiadan where  pz_time<=#"&date+2&"# and isnull(lc_hz) and (wc_name='' or isnull(wc_name)) and isnull(lc_wc) order by pz_time desc",conn,1,1
%><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"><tr><td><div align="center" class="style2"><table width="100%" border="0" cellpadding="0" cellspacing="0" background="img/33.JPG"><tr><td width="92%"><div align="center" class="style2"><div align="left">&nbsp;<span class="style4">&nbsp;最近三天拍照</span> &nbsp;&nbsp;</div></div></td><td width="8%"><a href="kan_qu.asp?action=hz" target="main2"><font color="#0000FF">更多．．</font></a></td></tr></table></div></td></tr><tr><td><table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC"><%
if rs.eof then
%><tr bgcolor="#FFFFFF"><td colspan="5"><div align="center"><span class="style1">当前无拍照化妆记录</span></div></td></tr><%
else
%><tr bgcolor="#99FFFF"><td><div align="center"><span class="STYLE10">单号/手动单号</span></div></td><td><div align="center">姓名</div></td><td><div align="center">联系电话</div></td><td><div align="center">门市</div></td><td><div align="center">拍照化妆时间</div></td></tr><%
do while not rs.eof
%><tr bgcolor="#FFFFFF"  onMouseOver="this.bgColor='#FF9966'" onMouseOut="this.bgColor='#FFFFFF'"><td><div align="center"><a href="javascript:openEditScript('kehu_mianban.asp?id=<%= rs("id") %>',450,500)">
                  <%
response.Write rs("id")
...
rs4.close()
set rs4=nothing
%></a></div></td><td align="left">&nbsp;<%= GetTelNo(conn.execute("select telephone from kehu where id="&rs("kehu_id")&"")(0)) %></td><td><div align="center"><%= (conn.execute("select peplename from yuangong where username='"&rs("userid")&"'")(0)) %></div></td><td><div align="left"> &nbsp;
                    <%
...
set rs=nothing
set rs=server.CreateObject("adodb.recordset")
rs.open "select * from shejixiadan where  hz_time<=#"&date+2&"# and isnull(hz_userid) and (wc_name='' or isnull(wc_name)) and isnull(lc_wc) order by hz_time desc",conn,1,1
%><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"><tr><td><div align="center" class="style2"><table width="100%" border="0" cellpadding="0" cellspacing="0" background="img/33.JPG"><tr><td width="92%"><div align="center" class="style2"><div align="left">&nbsp;<span class="style4">&nbsp;最近三天结婚化妆</span> &nbsp;&nbsp;</div></div></td><td width="8%"><a href="kan_qu.asp?action=hz" target="main2"><font color="#0000FF">更多．．</font></a></td></tr></table></div></td></tr><tr><td><table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC"><%
if rs.eof then
%><tr bgcolor="#FFFFFF"><td colspan="5"><div align="center"><span class="style1">当前无结婚化妆记录</span></div></td></tr><%
else
%><tr bgcolor="#99FFFF"><td><div align="center"><span class="STYLE10">单号/手动单号</span></div></td><td><div align="center">姓名</div></td><td><div align="center">联系电话</div></td><td><div align="center">门市</div></td><td><div align="center">结婚化妆时间</div></td></tr><%
do while not rs.eof
%><tr bgcolor="#FFFFFF"  onMouseOver="this.bgColor='#FF9966'" onMouseOut="this.bgColor='#FFFFFF'"><td><div align="center"><a href="javascript:openEditScript('kehu_mianban.asp?id=<%= rs("id") %>',450,500)">
                  <%
response.Write rs("id")
...
rs4.close()
set rs4=nothing
%></a></div></td><td>&nbsp;<%= GetTelNo(conn.execute("select telephone from kehu where id="&rs("kehu_id")&"")(0)) %></td><td><div align="center"><%= conn.execute("select peplename from yuangong where username='"&rs("userid")&"'")(0) %></div></td><td><div align="left"> &nbsp;
                    <%
