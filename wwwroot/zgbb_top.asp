...
End If
End Sub
%><html><head><meta http-equiv="Content-Type" content="text/html; charset=gb2312"><title>部门主管</title><style type="text/css"><!--
.style3 {color: #FF0000}
--></style><link href="admin/zxcss.css" rel="stylesheet" type="text/css"><script src="Js/Calendar.js"></script><script language="javascript" src="inc/func.js" type="text/javascript"></script><link href="Css/calendar-blue.css" rel="stylesheet"><link href="zxcss.css" rel="stylesheet" type="text/css"></head><body leftmargin="0" topmargin="0"><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0"><tr><form  target="main11" action="zgbb_print.asp" method="post" name="form1" ><td width="78%" height="20">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;时间查询
...
next
%></select><select name="month" id="month"><option value="<%
...
next
%></select><input name="chaxun" type="submit" id="chaxun" value="确定"></td><td width="10%"><a href="#" onClick="parent.main11.focus();parent.main11.print();">打印</a></td></form></tr></table></body></html>