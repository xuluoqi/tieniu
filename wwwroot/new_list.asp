...
%><meta http-equiv="Content-Type" content="text/html; charset=gb2312"><title><%= conn.execute("select title from wen_type where id="&request("type_id")&"")(0) %></title><script language="javascript" src="inc/func.js" type="text/javascript"></script></head><body><%
set rs=server.CreateObject("adodb.recordset")
rs.open "select * from wenzhang where id="&request("id")&"",conn,1,1
%><table width="99%" height="100%" border="1" align="center" cellpadding="0" cellspacing="0"><tr><td height="293" valign="top">&nbsp;&nbsp;
      <table width="91%" border="0" align="center" cellpadding="0" cellspacing="0"><tr><td width="683"><div align="center"><strong><%= rs("title") %></strong></div></td></tr></table><table width="96%" border="0" align="center" cellpadding="0" cellspacing="0"><tr><td>&nbsp;&nbsp;<%= rs("content") %></td></tr></table></td></tr></table><%
rs.close
set rs=nothing
%></body></html>