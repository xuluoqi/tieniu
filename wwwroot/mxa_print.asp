...
h_cp_id = Request.Form("h_cp_id")
h_ky_id = Request.Form("h_ky_id")
h_xg_id = Request.Form("h_xg_id")
h_jhz_id = Request.Form("h_jhz_id")
h_pzlf_id = Request.Form("h_pzlf_id")
h_jhlf_id2 = Request.Form("h_jhlf_id2")
if h_cp_id<>"" then
arr_cp_id = split(h_cp_id,", ")
for i=0 to ubound(arr_cp_id)
if trim(request.form("kj_time_"&arr_cp_id(i)))<>"" then
kj_time="#"&trim(request.form("kj_time_"&arr_cp_id(i)))&"#"
else
kj_time="null"
end if
if request.form("yx_cp_sig_"&arr_cp_id(i))="1" then
sql_cp_memo=",yx_cp_memo='"&request.form("yx_cp_memo_"&arr_cp_id(i))&"'"
elseif request.form("yx_cp_sig_"&arr_cp_id(i))="2" then
sql_cp_memo=",yx_cp_memo2='"&request.form("yx_cp_memo_"&arr_cp_id(i))&"'"
elseif request.form("yx_cp_sig_"&arr_cp_id(i))="3" then
sql_cp_memo=",yx_cp_memo3='"&request.form("yx_cp_memo_"&arr_cp_id(i))&"'"
end if
conn.execute("update shejixiadan set kj_time="&kj_time&",yx_ky_name='"&request.form("yx_cky_name_"&arr_cp_id(i))&"',yx_cp_name='"&request.form("yx_cp_name_"&arr_cp_id(i))&"',pz='"&request.form("yx_pz_"&arr_cp_id(i))&"',yx_cp_name2='"&request.form("yx_cp_name2_"&arr_cp_id(i))&"',yx_hzzl_name='"&request.form("yx_hzzl_name_"&arr_cp_id(i))&"',yx_cpzl_name='"&request.form("yx_cpzl_name_"&arr_cp_id(i))&"',yx_jhlf_name='"&request.form("yx_cp_jhlf_name_"&arr_cp_id(i))&"',yx_hz_name='"&request.form("yx_hz_name_"&arr_cp_id(i))&"',yx_hz_name2='"&request.form("yx_hz_name2_"&arr_cp_id(i))&"'"& sql_cp_memo &" where id="&arr_cp_id(i))
next
end if
if h_ky_id<>"" then
arr_ky_id = split(h_ky_id,", ")
for i=0 to ubound(arr_ky_id)
conn.execute("update shejixiadan set yx_ky_name='"&request.form("yx_ky_name_"&arr_ky_id(i))&"',kj='"&request.form("yx_ky_"&arr_ky_id(i))&"',yx_cp_memo='"&request.form("yx_cp_memo2_"&arr_ky_id(i))&"' where id="&arr_ky_id(i))
next
end if
if h_xg_id<>"" then
arr_xg_id = split(h_xg_id,", ")
for i=0 to ubound(arr_xg_id)
conn.execute("update shejixiadan set yx_xg_name='"&request.form("yx_xg_name_"&arr_xg_id(i))&"' where id="&arr_xg_id(i))
next
end if
if h_jhz_id<>"" then
arr_jhz_id = split(h_jhz_id,", ")
for i=0 to ubound(arr_jhz_id)
conn.execute("update shejixiadan set yx_jhz_name='"&request.form("yx_jhz_name_"&arr_jhz_id(i))&"',yx_jhlf_name='"&request.form("yx_jhlf_name_"&arr_jhz_id(i))&"',emcee_name='"&request.form("emcee_name_"&arr_jhz_id(i))&"',rec_name='"&request.form("rec_name_"&arr_jhz_id(i))&"',car_info='"&request.form("car_info_"&arr_jhz_id(i))&"',locale_time='"&request.form("locale_time_"&arr_jhz_id(i))&"',yx_cp_memo='"&request.form("yx_jhz_memo_"&arr_jhz_id(i))&"' where id="&arr_jhz_id(i))
next
end if
if h_pzlf_id<>"" then
arr_pzlf_id = split(h_pzlf_id,", ")
for i=0 to ubound(arr_pzlf_id)
conn.execute("update shejixiadan set yx_hzzl_name='"&request.form("yx_pzlf_name_"&arr_pzlf_id(i))&"' where id="&arr_pzlf_id(i))
next
end if
if h_jhlf_id2<>"" then
arr_jhlf_id2 = split(h_jhlf_id2,", ")
for i=0 to ubound(arr_jhlf_id2)
conn.execute("update shejixiadan set yx_xg_name='"&request.form("yx_jhlf_name_"&arr_jhlf_id2(i))&"' where id="&arr_jhlf_id2(i))
next
end if
if err.number>0 then
response.Write "<script language=javascript>alert('错误信息："&err.description&".');history.go(-1);</script>"
On Error GoTo 0
Err.Raise 9999
else
response.Write "<script language=javascript>alert('数据保存成功.');</script>"
end if
end if
...
%><meta http-equiv="Content-Type" content="text/html; charset=gb2312"><link href="admin/zxcss.css" rel="stylesheet" type="text/css"><script language="javascript" src="inc/func.js" type="text/javascript"></script><script language="javascript">
...
</script><script src="Js/Calendar.js"></script><link href="Css/calendar-blue.css" rel="stylesheet"><style type="text/css"><!--
body {
...
.STYLE5 {font-size: 12}
--></style><body topmargin="0" leftmargin="0"><div id="loadingimg" align="center" style="width:100%; padding-top:100px; float:left; display:none"><img src="Image/loading.gif" width="16" height="16"><br><br><div id="loadingtext">正在载入数据,请稍等...</div></div><script language="javascript">loadingShow();</script><%
Response.Flush()
%><form name="yx_form" action="mxa_print.asp?action=save" method="post"><center><%= yeard %>年<%= monthd %>月<%= dayd %>日
	[
	  <%
...
sub show_cp()
%><span class="STYLE5"><br></span><span class="STYLE4">摄影表</span><br><br></center><table width="100%" height="25" border="1" cellspacing="0"><tr  bgcolor="#66FFFF" align="center" height="25"><td height="25">手动单号<br>
      单号/时间<br>
婚期</td><td><%= GetAppellation(3, null) %></td><td><%= GetAppellation(4, null) %></td><td>套系<br>
      金额</td><td>摄影<br>
      时间</td><td>选片日期</td><td>预选片师</td><td>预<%= GetWorkName("hz") %><br>
      预<%= GetWorkName("hz") %>助理</td><td>预<%= GetWorkName("hz") %>2</td><td>预摄影师1<br>
      预摄影助理</td><td>预摄影师2</td><td>预礼服师</td><td>景点&nbsp;</td><td>&nbsp;备注</td></tr><%
dim sqlpz
sqlpz="select * from (SELECT s.ID, s.danhao, s.kehu_id, s.jixiang_money, pz_time, s.pz, s.hz_time, s.userid, s.yx_cp_name, s.yx_cp_name2, s.yx_cp_name3, s.cp_name, s.cp_name2, s.cp_name2, s.cp_name3, s.cp_name4, s.cp_name5, s.cpVolume, s.yx_hz_name, s.yx_hz_name2, s.hz_name, s.yx_hzzl_name, s.hz_name2, s.yx_ky_name, s.yunyong, s.sl, s.yx_cpzl_name, s.yx_jhlf_name, s.hs_userid, s.kj_time, s.yx_cp_memo,s.yx_cp_memo2,s.yx_cp_memo3,s.tc_pz_time,s.tc_pz_time2,s.tc_pz_time3,1 as sig FROM shejixiadan s LEFT JOIN kehu k ON s.kehu_id = k.ID where s.pz_time=#"&times&"#"&sqlshop&" union all SELECT s.ID, s.danhao, s.kehu_id, s.jixiang_money, pz_time2 as pz_time, pz2 as pz, s.hz_time, s.userid, s.yx_cp_name, s.yx_cp_name2, s.yx_cp_name3, s.cp_name, s.cp_name2, s.cp_name2, s.cp_name3, s.cp_name4, s.cp_name5, s.cpVolume, s.yx_hz_name, s.yx_hz_name2, s.hz_name, s.yx_hzzl_name, s.hz_name2, s.yx_ky_name, s.yunyong, s.sl, s.yx_cpzl_name, s.yx_jhlf_name, s.hs_userid, s.kj_time, s.yx_cp_memo,s.yx_cp_memo2,s.yx_cp_memo3,s.tc_pz_time,s.tc_pz_time2,s.tc_pz_time3,2 as sig FROM shejixiadan s LEFT JOIN kehu k ON s.kehu_id = k.ID where pz_time2=#"&times&"#"&sqlshop&" union all SELECT s.ID, s.danhao, s.kehu_id, s.jixiang_money, pz_time3 as pz_time, pz3 as pz, s.hz_time, s.userid, s.yx_cp_name, s.yx_cp_name2, s.yx_cp_name3, s.cp_name, s.cp_name2, s.cp_name2, s.cp_name3, s.cp_name4, s.cp_name5, s.cpVolume, s.yx_hz_name, s.hz_name, s.yx_hzzl_name, s.hz_name2, s.yx_ky_name, s.yx_hz_name2, s.yunyong, s.sl, s.yx_cpzl_name, s.yx_jhlf_name, s.hs_userid, s.kj_time, s.yx_cp_memo,s.yx_cp_memo2,s.yx_cp_memo3,s.tc_pz_time,s.tc_pz_time2,s.tc_pz_time3,3 as sig FROM shejixiadan s LEFT JOIN kehu k ON s.kehu_id = k.ID where pz_time3=#"&times&"#"&sqlshop&") order by pz"
set rs=server.CreateObject("adodb.recordset")
...
if isnull(money5) then money5=0
%><tr  bgcolor="#FFFFFF" onMouseOver="this.bgColor='#FF9966'" onMouseOut="this.bgColor='#FFFFFF'"  style="cursor:hand"><span onClick="javascript:openEditScript('<%= pageurl %>?id=<%= rs("id") %>',450,500)"> 
    <td  height="25" align="center"><%
if rs("danhao")<>"" and not isnull(rs("danhao")) then
response.write rs("danhao")&"<br>"
end if
%><%= rs("id") %>/<%= rs("pz") %><br><%= rs("hz_time") %><input name="h_cp_id" type="hidden" id="h_cp_id" value="<%= rs("id") %>"></td><td align="center">&nbsp;<%
...
%></td><td align="center">&nbsp;<%= arr(1) %></td><td align="center"><%= rs("jixiang_money") %></td></span><td align="center"><input name="yx_pz_<%= rs("id") %>" type="text" id="yx_pz_<%= rs("id") %>" size="3" value="<%= rs("pz") %>"></td><td align="center" style="white-space:nowrap"><input name="kj_time_<%= rs("id") %>" type="text" maxlength="10"  size="10" value="<%= rs("kj_time") %>"><a onClick="return showCalendar('kj_time_<%= rs("id") %>', 'y-mm-dd');" href="#"><img src="Image/Button.gif" width="25" height="17" border="0" align="absMiddle" id="IMG3" /></a></td><td align="center"><span class="font"><select name="yx_cky_name_<%= rs("id") %>" id="yx_cky_name_<%= rs("id") %>">
...
rscp.close
set rscp = nothing
%></select></span></td><td align="center"><span class="font"><select name="yx_hz_name_<%= rs("id") %>" id="yx_hz_name_<%= rs("id") %>" style="width:60px">
        <option value="">未安排</option><%
set rscp = server.CreateObject("adodb.recordset")
rscp.open "select id,peplename from yuangong where [level] in (5, 14) and isdisabled=0",conn,1,1
do while not rscp.eof
response.write "<option value='"&rscp("peplename")&"'"
...
rscp.close
set rscp = nothing
%></select><br><select name="yx_hzzl_name_<%= rs("id") %>" id="yx_hzzl_name_<%= rs("id") %>" style="width:60px">
        <option value="">未安排</option><%
set rscp = server.CreateObject("adodb.recordset")
...
rscp.close
set rscp = nothing
%></select></span></td><td align="center"><span class="font"><select name="yx_hz_name2_<%= rs("id") %>" id="yx_hz_name2_<%= rs("id") %>" style="width:60px">
        <option value="">未安排</option><%
set rscp = server.CreateObject("adodb.recordset")
rscp.open "select id,peplename from yuangong where [level] in (5, 14) and isdisabled=0",conn,1,1
do while not rscp.eof
response.write "<option value='"&rscp("peplename")&"'"
if rscp("peplename")=rs("yx_hz_name2") then response.write " selected"
response.write ">"&rscp("peplename")&"</option>"
rscp.movenext
loop
rscp.close
set rscp = nothing
%></select></span></td><td align="center"><span class="font"><select name="yx_cp_name_<%= rs("id") %>" id="yx_cp_name_<%= rs("id") %>" style="width:60px">
        <option value="">未安排</option><%
set rscp = server.CreateObject("adodb.recordset")
rscp.open "select id,peplename from yuangong where [level] in (4, 12) and isdisabled=0",conn,1,1
do while not rscp.eof
response.write "<option value='"&rscp("peplename")&"'"
...
rscp.close
set rscp = nothing
%></select><br><select name="yx_cpzl_name_<%= rs("id") %>" id="yx_cpzl_name_<%= rs("id") %>" style="width:60px">
        <option value="">未安排</option><%
set rscp = server.CreateObject("adodb.recordset")
rscp.open "select id,peplename from yuangong where [level]=12 and isdisabled=0",conn,1,1
do while not rscp.eof
response.write "<option value='"&rscp("peplename")&"'"
if rscp("peplename")=rs("yx_cpzl_name") then response.write " selected"
response.write ">"&rscp("peplename")&"</option>"
rscp.movenext
loop
rscp.close
set rscp = nothing
%></select></span></td><td align="center"><span class="font"><select name="yx_cp_name2_<%= rs("id") %>" id="yx_cp_name2_<%= rs("id") %>" style="width:60px">
        <option value="">未安排</option><%
set rscp = server.CreateObject("adodb.recordset")
rscp.open "select id,peplename from yuangong where [level] in (4, 12) and isdisabled=0",conn,1,1
do while not rscp.eof
...
rscp.close
set rscp = nothing
%></select></span></td><td align="center"><select name="yx_cp_jhlf_name_<%= rs("id") %>" id="yx_cp_jhlf_name_<%= rs("id") %>" style="width:60px">
      <option value="">未安排</option><%
set rscp = server.CreateObject("adodb.recordset")
rscp.open "select id,peplename from yuangong where ([level]=11 or [level]=14) and isdisabled=0 order by [level]",conn,1,1
do while not rscp.eof
response.write "<option value='"&rscp("peplename")&"'"
...
set rswj = Nothing
End If
%>&nbsp;</td><td align="center"><input type="hidden" name="yx_cp_sig_<%= rs("id") %>" id="yx_cp_sig_<%= rs("id") %>" value="<%= rs("sig") %>"><input name="yx_cp_memo_<%= rs("id") %>" type="text" id="yx_cp_memo_<%= rs("id") %>" size="8" value="<%
if rs("sig")=1 then
response.write rs("yx_cp_memo")
elseif rs("sig")=2 then
response.write rs("yx_cp_memo2")
elseif rs("sig")=3 then
response.write rs("yx_cp_memo3")
end if
%>"></td></tr><%
rs.movenext
wend
...
sub show_ky()
%><p align="center" class="STYLE4">选片表</p><table width="100%" border="1" cellspacing="0"><tr bgcolor="#66FFFF" align="center" height="25"><td width="12%" height="25">手动单号<br>单号/时间<br>
婚期</td><td>套系</td><td><%= GetAppellation(3, null) %></td><td><%= GetAppellation(4, null) %></td><td>&nbsp;选片门市</td><td>选片时间</td><td>预设选片门市</td><td>&nbsp;备注</td></tr><%
year1=year(times)
day1=day(times)
month1=month(times)
set rs=server.CreateObject("adodb.recordset")
'
'
rs.open "select * from shejixiadan where kj_time=#"&times&"#  order by hz_time desc",conn,1,1
while not rs.eof
...
money4=conn.execute("select jixiang_money from shejixiadan where id="&rs("id")&"")(0)
if isnull(conn.execute("select sum(money) from save_money where xiangmu_id="&rs("id")&"")(0)) then
money5=0
else
money5=conn.execute("select sum(money) from save_money where xiangmu_id="&rs("id")&"")(0)
end if
%><tr align="center" bgcolor="#FFFFFF" onMouseOver="this.bgColor='#FF9966'" onMouseOut="this.bgColor='#FFFFFF'" style="cursor:hand"><span onClick="javascript:openEditScript('<%= pageurl %>?id=<%= rs("id") %>',450,500)">
    <td  height="25"><%
if rs("danhao")<>"" and not isnull(rs("danhao")) then
response.write rs("danhao")&"<br>"
end if
%><%= rs("id") %>/<%= rs("kj") %><br><%= rs("hz_time") %><input name="h_ky_id" type="hidden" id="h_ky_id" value="<%= rs("id") %>"></td><td><%= GetFieldDataBySQL("select jixiang from jixiang where id="&rs("jixiang"),"str","") %>&nbsp;</td><td>&nbsp;
        <%
arr = GetCustName(rs("kehu_id"))
if not isarray(arr) then
redim arr(1)
...
%>&nbsp;</td></span><td><input name="yx_ky_<%= rs("id") %>" type="text" id="yx_ky_<%= rs("id") %>" size="5" value="<%= rs("kj") %>"></td><td><span class="font"><select name="yx_ky_name_<%= rs("id") %>" id="yx_ky_name_<%= rs("id") %>">
        <option value="">未安排</option><%
set rscp = server.CreateObject("adodb.recordset")
rscp.open "select id,peplename from yuangong where [level]=1 and isdisabled=0",conn,1,1
do while not rscp.eof
...
rscp.close
set rscp = nothing
%></select></span></td><td><input name="yx_cp_memo2_<%= rs("id") %>" type="text" id="yx_cp_memo2_<%= rs("id") %>" size="8" value="<%= rs("yx_cp_memo") %>"></td></tr><%
rs.movenext
wend
rs.close
set rs=nothing
...
sub show_xg()
%><p align="center" class="STYLE4">看版表</p><table width="100%" border="1" cellspacing="0"><tr bgcolor="#66FFFF" align="center" height="25"><td height="25">手动单号<br>单号/时间<br>
婚期</td><td><%= GetAppellation(3, null) %></td><td><%= GetAppellation(4, null) %></td><td>&nbsp;看版门市</td><td>预设看版人员</td></tr><%
year1=year(times)
day1=day(times)
month1=month(times)
set rs=server.CreateObject("adodb.recordset")
'
'
rs.open "select * from shejixiadan where xg_time=#"&times&"#  order by xg_time desc",conn,1,1
while not rs.eof
if not isnull(conn.execute("select sum(money) from fujia where xiangmu_id="&rs("id")&"")(0)) then
money1=conn.execute("select sum(money) from fujia where xiangmu_id="&rs("id")&"")(0)
else
...
%><%= rs("id") %>/<%= rs("xg") %><br><%= rs("hz_time") %><input name="h_xg_id" type="hidden" id="h_xg_id" value="<%= rs("id") %>"></td><td>&nbsp;
      <%
arr = GetCustName(rs("kehu_id"))
if not isarray(arr) then
redim arr(1)
...
response.write arr(0)
%></td><td>&nbsp;<%= arr(1) %></td><td><%= rs("xg_name") %>&nbsp;</td></span><td><select name="yx_xg_name_<%= rs("id") %>" id="yx_xg_name_<%= rs("id") %>">
        <option value="">未安排</option><%
set rscp = server.CreateObject("adodb.recordset")
...
sub show_jhz()
%><p align="center" class="STYLE4"><a href="mxa_print.asp?fromtime=<%= times %>&s=jhz" title="单页显示结婚化妆表">结婚化妆表</a></p><table width="100%" border="1" cellspacing="0"><tr  bgcolor="#66FFFF" align="center" height="25"><td height="25">手动单号<br>单号/时间<br>
婚期</td><td><%= GetAppellation(3, null) %></td><td><%= GetAppellation(4, null) %></td><td><%= GetDutyName(5) %></td><td>预设结婚<br><%= GetDutyName(5) %></td><td>预设结婚<br>
      礼服师</td><td>司仪</td><td>摄像</td><td>婚车</td><td>现场时间</td><td>&nbsp;备注</td></tr><%
set rs=server.CreateObject("adodb.recordset")
rs.open "select * from shejixiadan where hz_time=#"&times&"#  order by hz_time desc",conn,1,1
while not rs.eof
if not isnull(conn.execute("select sum(money) from fujia where xiangmu_id="&rs("id")&"")(0)) then
money1=conn.execute("select sum(money) from fujia where xiangmu_id="&rs("id")&"")(0)
else
...
%><%= rs("id") %>/<%= rs("hz") %><br><%
if not isnull(rs("hz_time")) then
response.write month(rs("hz_time"))&"-"&day(rs("hz_time"))
end if
%><input name="h_jhz_id" type="hidden" id="h_jhz_id" value="<%= rs("id") %>"></td><td>&nbsp;
        <%
arr = GetCustName(rs("kehu_id"))
if not isarray(arr) then
redim arr(1)
...
set rshz = server.CreateObject("adodb.recordset")
rshz.open "select peplename from yuangong where username='"&rs("hz_userid")&"'",conn,1,1
if not rshz.eof then
response.write rshz("peplename")
end if
rshz.close
set rshz = nothing
else
...
%></td></span><td><select name="yx_jhz_name_<%= rs("id") %>" id="yx_jhz_name_<%= rs("id") %>">
        <option value="">未安排</option><%
set rscp = server.CreateObject("adodb.recordset")
rscp.open "select id,peplename from yuangong where ([level]=5 or [level]=14) and isdisabled=0 order by [level],username",conn,1,1
do while not rscp.eof
response.write "<option value='"&rscp("peplename")&"'"
...
rscp.close
set rscp = nothing
%></select></td><td><select name="yx_jhlf_name_<%= rs("id") %>" id="yx_jhlf_name_<%= rs("id") %>">
      <option value="">未安排</option><%
set rscp = server.CreateObject("adodb.recordset")
rscp.open "select id,peplename from yuangong where ([level]=5 or [level]=11 or [level]=14) and isdisabled=0 order by [level],username",conn,1,1
do while not rscp.eof
response.write "<option value='"&rscp("peplename")&"'"
if rscp("peplename")=rs("yx_jhlf_name") then response.write " selected"
response.write ">"&rscp("peplename")&"</option>"
...
rscp.close
set rscp = nothing
%></select></td><td><input name="emcee_name_<%= rs("id") %>" type="text" id="emcee_name_<%= rs("id") %>" size="8" value="<%= rs("emcee_name") %>"></td><td><input name="rec_name_<%= rs("id") %>" type="text" id="rec_name_<%= rs("id") %>" size="8" value="<%= rs("rec_name") %>"></td><td><input name="car_info_<%= rs("id") %>" type="text" id="car_info_<%= rs("id") %>" size="8" value="<%= rs("car_info") %>"></td><td><input name="locale_time_<%= rs("id") %>" type="text" id="locale_time_<%= rs("id") %>" size="8" value="<%= rs("locale_time") %>"></td><td><input name="yx_jhz_memo_<%= rs("id") %>" type="text" id="yx_jhz_memo_<%= rs("id") %>" size="15" value="<%= rs("yx_cp_memo") %>"></td></tr><%
rs.movenext
wend
rs.close
set rs=nothing
...
sub show_pzlf()
%><p align="center" class="STYLE4"><a href="mxa_print.asp?fromtime=<%= times %>&s=pzlf&shopid=<%= defshopvalue %>" title="单页显示拍照礼服表">拍照礼服表</a></p><table width="100%" border="1" cellspacing="0"><tr  bgcolor="#66FFFF" align="center" height="25"><td width="13%" height="25">手动单号<br>
      单号/时间<br>
      婚期</td><td width="13%"><%= GetAppellation(3, null) %></td><td width="13%"><%= GetAppellation(4, null) %></td><td width="15%">预设拍照<br>
      礼服师</td><td width="15%">时间段</td><td width="15%"><%= GetWorkName("hz") %></td><td width="35%">&nbsp;备注</td></tr><%
set rs=server.CreateObject("adodb.recordset")
rs.open "select * from shejixiadan where pzlf_time=#"&times&"# order by id",conn,1,1
do while not rs.eof
tc_row = GetDatecolor(rs("tc_pzlf_time"), "")
if tc_row="" or isnull(tc_row) then tc_row="#ffffff"
%><tr bgcolor="#FFFFFF" onMouseOver="this.bgColor='#FF9966'" onMouseOut="this.bgColor='#FFFFFF'" style="cursor:hand"><td  height="25" align="center"><span onClick="javascript:openEditScript('<%= pageurl %>?id=<%= rs("id") %>',450,500)">
      <%
if rs("danhao")<>"" and not isnull(rs("danhao")) then
response.write rs("danhao")&"<br>"
end if
response.write rs("id")&"/"&rs("pzlf")
%><br><%= rs("hz_time") %><input name="h_pzlf_id" type="hidden" id="h_pzlf_id" value="<%= rs("id") %>">
    </span></td><td align="center"><span onClick="javascript:openEditScript('<%= pageurl %>?id=<%= rs("id") %>',450,500)">
      <%
arr = GetCustName(rs("kehu_id"))
if not isarray(arr) then
redim arr(1)
...
response.write arr(0)
%></span></td><td align="center"><span onClick="javascript:openEditScript('<%= pageurl %>?id=<%= rs("id") %>',450,500)">&nbsp;<%= arr(1) %></span></td><td align="center"><select name="yx_pzlf_name_<%= rs("id") %>" id="yx_pzlf_name_<%= rs("id") %>">
      <option value="">未安排</option><%
set rscp = server.CreateObject("adodb.recordset")
rscp.open "select id,peplename from yuangong where ([level]=5 or [level]=14) and isdisabled=0 order by [level],username",conn,1,1
do while not rscp.eof
...
%></td><td align="center">&nbsp;<%= rs("hz_name") %></td><td>&nbsp;</td></tr><%
rs.movenext
loop
rs.close
set rs=nothing
...
sub show_jhlf()
%><p align="center" class="STYLE4"><a href="mxa_print.asp?fromtime=<%= times %>&s=jhlf&shopid=<%= defshopvalue %>" title="单页显示结婚礼服表">结婚礼服表</a></p><table width="100%" border="1" cellspacing="0"><tr  bgcolor="#66FFFF" align="center" height="25"><td height="25">手动单号<br>系统单号<br>
婚期</td><td><%= GetAppellation(3, null) %></td><td><%= GetAppellation(4, null) %></td><td>预设结婚<br>
礼服师</td><td>时间段</td><td>出件时间</td><td>返件时间</td><td>结婚化妆</td><td width="200">&nbsp;备注</td></tr><%
set rs=server.CreateObject("adodb.recordset")
...
%><%= rs("id") %><br><%= rs("hz_time") %><input name="h_jhlf_id2" type="hidden" id="h_jhlf_id2" value="<%= rs("id") %>"></td><td align="center"><%
arr = GetCustName(rs("kehu_id"))
if not isarray(arr) then
redim arr(1)
arr(0) = "N/A"
...
response.write arr(0)
%></td><td align="center">&nbsp;<%= arr(1) %></td></span><td align="center"><select name="yx_jhlf_name2_<%= rs("id") %>" id="yx_jhlf_name2_<%= rs("id") %>">
      <option value="">未安排</option><%
set rscp = server.CreateObject("adodb.recordset")
rscp.open "select id,peplename from yuangong where ([level]=5 or [level]=14) and isdisabled=0 order by [level],username",conn,1,1
do while not rscp.eof
...
%></td><td align="center"><%= indate %>&nbsp;</td><td align="center"><%= outdate %>&nbsp;</td><td align="center">&nbsp;<%
if rs("hz_userid")<>"" and not isnull(rs("hz_userid")) then
...
%><br><br><table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td align="center"><input type="submit" name="Submit" value="提交"><input type="reset" name="Submit" value="重置"><input name="fromtime" type="hidden" id="fromtime" value="<%= times %>"></td></tr></table></form><p><br></p><p align="center" class="STYLE4"><br></p><script language="javascript">loadingHidden();</script></body></html>