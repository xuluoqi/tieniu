...
End If
End Sub
%><html><head><meta http-equiv="Content-Type" content="text/html; charset=gb2312"><title>无标题文档</title><script language="javascript" src="inc/func.js" type="text/javascript"></script><script language="javascript">
function check()
{
if(!CheckIsNull(document.form1.title,"请天下标题！")) return false;
if(!CheckIsNull(document.form1.neirong,"请填写内容！"))return false;
if(!CheckIsNull(document.form1.shuoming,"请填写需要公司配合内容！"))return false;
}
</script><link href="admin/zxcss.css" rel="stylesheet" type="text/css"><style type="text/css"><!--
.style1 {color: #0033FF}
--></style></head><body><%
neirong=HTMLEncode2(request("neirong"))
set rs=server.CreateObject("adodb.recordset")
sql="select * from jishiben where id="&request("id")&""
...
rs.close
set rs=nothing
response.Write "<script>alert('修改成功!'); location='jishiben.asp'</script>"
end if
set rs1=server.CreateObject("adodb.recordset")
sql="select * from jishiben where id="&request("id")&""
rs1.open sql,connstr,1,1
if rs1("times")<date or rs1("yewuyuan")<>session("username") then response.Write "<script>alert('你无权限进入该页面！');history.go(-1)</script>"
%><p>&nbsp;</p><table width="566" height="347" border="0" align="center" cellpadding="0" cellspacing="0"><form action="" method="post" name="form1" onSubmit="return check()"><tr><td height="30" colspan="2"><div align="center" class="style1"></div><div align="center"><span class="style1">记事本修改</span></div></td></tr><tr><td width="105" height="20"><div align="right">标题：</div></td><td width="461"><input name="title" type="text" id="title" size="56" value="<%= rs1("title") %>"></td></tr><tr><td height="111" valign="top"><div align="right">内容：
    </div></td><td><textarea name="neirong" cols="75" rows="8" id="neirong" ><%= encode2(rs1("neirong")) %></textarea></td></tr><tr><td height="79" valign="top"><div align="right">公司配合说明:
      </div></td><td><div align="left"><textarea name="shuoming" cols="75" rows="8" id="shuoming"><%= encode2(rs1("shuoming")) %></textarea></div></td></tr><tr><td height="39">&nbsp;</td><td><div align="left">
         　　　　　　　　　  　　　
      ...
      </div></td></tr></form></table><blockquote><p></p></blockquote><%
rs1.close
set rs1=nothing
%></body></html>