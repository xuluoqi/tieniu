...
End If
End Sub
%><html><head><meta http-equiv="Content-Type" content="text/html; charset=gb2312"><title>客服回复</title><script language="javascript" src="inc/func.js" type="text/javascript"></script><script language="javascript">
function check()
{
...
</script><link href="admin/zxcss.css" rel="stylesheet" type="text/css"></head><body><%
set rs=server.CreateObject("adodb.recordset")
...
alert("回复日程成功！");location="llrc2.asp?id=<%= request("id") %>";window.close();
window.opener.location.reload();
</script><%
end if
%><p>&nbsp;</p><table width="397" height="220" border="0" align="center" cellpadding="0" cellspacing="0"><form action="huifu.asp" method="post" name="form1" onSubmit="return check()"><tr><td height="21"><div align="center">回复客服</div></td></tr><tr><td height="120"><div align="center"><textarea name="huifu" cols="70" rows="8" id="huifu"><%= rs("huifu") %></textarea></div></td></tr><tr><td height="79"><div align="center"><input name="tijiao" type="submit" id="tijiao" value="提交">　　　　      
            
        <input type="button" name="Submit" value="返回" onClick="javascript:window.close()"><input name="id" type="hidden" value="<%= request("id") %>">
