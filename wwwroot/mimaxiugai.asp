...
End If
End Sub
%><html><head><meta http-equiv="Content-Type" content="text/html; charset=gb2312"><title>修改密码</title><script language="javascript" src="inc/func.js" type="text/javascript"></script><style type="text/css"><!--
.fdsf {
...
--></style></head><body><form name="form1" method="post" action=""><table width="455" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#CCFFFF"><tr><td width="453" bgcolor="#FFFFFF"><%
if session("level")=1 then
%>
	  　<span class="style17"><a href="jishiben.asp"></a>&nbsp;&nbsp;&nbsp;　<a href="zhoubaobiao.asp"></a>　　<a href="zhoubaobiao_look.asp"></a>　<a href="yuebaobiao_add.asp"></a>　<a href="yuebaobiao_look.asp"></a></span><%
end if
%></td></tr></table><table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td height="25"><%
if request("queding")="确定" then
if  request("newpassword")="" or request("newpassword2")="" or request("oldpassword")="" then
response.Write "<script>alert('请填写完整！');</script>"
else
set rs=server.CreateObject("adodb.recordset")
sql="select * from yuangong where username='"&session("userid")&"'"
rs.open sql,connstr,2,3
if rs("password")=md5(trim(request("oldpassword"))) then
if request.Form("newpassword")=request.Form("newpassword2") then
rs("password")=md5(trim(request.Form("newpassword")))
rs.update
rs.close
set rs=nothing
response.Write "<script>alert('密码修改成功！');</script>"
else
response.Write "<script>alert('新密码两次输入不一致！');</script>"
end if
else
...
%></td></tr><tr><td height="332"><table width="35%" height="89" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC" class="fdsf"><tr bgcolor="#FFFFFF"><td width="43%" height="22"><div align="right">原始密码：</div></td><td width="57%"><input name="oldpassword" type="password" id="oldpassword" size="15"></td></tr><tr bgcolor="#FFFFFF"><td height="20"><div align="right">新密码：</div></td><td><input name="newpassword" type="password" id="newpassword" size="15"></td></tr><tr bgcolor="#FFFFFF"><td height="22"><div align="right">确认密码：</div></td><td><input name="newpassword2" type="password" id="newpassword2" size="15"></td></tr></table><div align="center"><table width="34%"  border="0" cellspacing="0" cellpadding="0"><tr><td height="46"><div align="center"><input name="queding" type="submit" id="queding2" value="确定">
  　　　　　　
    <input name="reset" type="reset" id="reset" value="取消"></div></td></tr></table></div></td></tr></table></form></body></html>